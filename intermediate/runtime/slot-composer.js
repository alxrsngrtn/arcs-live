...
export class SlotComposer {
    ...
    constructor(options) {
        ...
        assert(options.rootContainer !== undefined ^ options.noRoot === true, 'Root container is mandatory unless it is explicitly skipped');
    ...
    renderSlot(particle, slotName, content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield slotConsumer.setContent(content, eventlet => {
