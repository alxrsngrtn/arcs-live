...
export class ParticleExecutionHost {
    constructor(port, slotComposer, arc) {
        ...
        this._apiPort.onInitializeProxy = ({ handle, callback }) => __awaiter(this, void 0, void 0, function* () {
            let target = {};
            handle.on('change', data => this._apiPort.SimpleCallback({ callback, data }), target);
        });
        this._apiPort.onSynchronizeProxy = ({ handle, callback }) => __awaiter(this, void 0, void 0, function* () {
            let data = yield handle.toLiteral();
            this._apiPort.SimpleCallback({ callback, data });
        });
        this._apiPort.onHandleGet = ({ handle, callback }) => __awaiter(this, void 0, void 0, function* () {
            this._apiPort.SimpleCallback({ callback, data: yield handle.get() });
        });
        this._apiPort.onHandleToList = ({ handle, callback }) => __awaiter(this, void 0, void 0, function* () {
            this._apiPort.SimpleCallback({ callback, data: yield handle.toList() });
        });
        ...
        this._apiPort.onArcCreateHandle = ({ callback, arc, type, name }) => __awaiter(this, void 0, void 0, function* () {
            ...
            // in firebase.
            let store = yield this._arc.createStore(type, name, null, [], 'in-memory');
            this._apiPort.CreateHandleCallback(store, { type, name, callback, id: store.id });
        });
        this._apiPort.onArcMapHandle = ({ callback, arc, handle }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this._apiPort.onArcLoadRecipe = ({ arc, recipe, callback }) => __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.parse(recipe, { loader: this._arc._loader, fileName: '' });
            let error = undefined;
            ...
            if (recipe0) {
                ...
                if (missingHandles.length > 0) {
                    const resolvedRecipe = yield new RecipeResolver(this._arc).resolve(recipe0);
                    if (!resolvedRecipe) {
        ...
        this._apiPort.onRaiseSystemException = ({ exception, methodName, particleId }) => __awaiter(this, void 0, void 0, function* () {
