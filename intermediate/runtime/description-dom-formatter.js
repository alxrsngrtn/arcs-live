    ...
    _combineSelectedDescriptions(selectedDescriptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let particleDesc of selectedDescriptions) {
                ...
                let success = yield Promise.all(Object.keys(model).map((tokenKey) => __awaiter(this, void 0, void 0, function* () {
                    let tokens = this._initSubTokens(model[tokenKey], particleDesc);
                    let token = tokens[0];
                    return (yield Promise.all(tokens.map((token) => __awaiter(this, void 0, void 0, function* () {
                        let tokenValue = yield this.tokenToString(token);
