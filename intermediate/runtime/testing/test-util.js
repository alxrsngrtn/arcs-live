...
export class ResultInspector {
    ...
    verify(...expectations) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._arc.idle;
            let received = yield this._store.toList();
            let misses = [];
...
export function assertSingletonWillChangeTo(arc, store, field, expectation) {
    return __awaiter(this, void 0, void 0, function* () {
        yield arc.idle;
        return assertSingletonIs(store, field, expectation);
    });
}
export function assertSingletonIs(store, field, expectation) {
    return __awaiter(this, void 0, void 0, function* () {
        let actual = yield store.get();
