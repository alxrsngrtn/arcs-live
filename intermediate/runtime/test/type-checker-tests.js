...
describe('TypeChecker', () => {
    it('resolves a trio of in [~a], out [~b], in [Product]', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('resolves a trio of in [Thing], in [Thing], out [Product]', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('resolves a trio of out [Product], in [Thing], in [Thing]', () => __awaiter(this, void 0, void 0, function* () {
        let a = Type.newEntity(new Schema({ names: ['Thing'], fields: {} })).collectionOf();
        let b = Type.newEntity(new Schema({ names: ['Thing'], fields: {} })).collectionOf();
        let c = Type.newEntity(new Schema({ names: ['Product', 'Thing'], fields: {} })).collectionOf();
    ...
    it('resolves a trio of in [~a] (is Thing), in [~b] (is Thing), out [Product]', () => __awaiter(this, void 0, void 0, function* () {
        let a = Type.newVariable(new TypeVariable('a')).collectionOf();
        let b = Type.newVariable(new TypeVariable('b')).collectionOf();
    ...
    it('resolves a pair of in [~a] (is Thing), out [Product]', () => __awaiter(this, void 0, void 0, function* () {
        let a = Type.newVariable(new TypeVariable('a')).collectionOf();
        let resolution = Type.newEntity(new Schema({ names: ['Thing'], fields: {} }));
        a.primitiveType().variable.resolution = resolution;
        let c = Type.newEntity(new Schema({ names: ['Product', 'Thing'], fields: {} })).collectionOf();
    ...
    it('doesn\'t resolve a pair of out [~a (is Thing)], in [Product]', () => __awaiter(this, void 0, void 0, function* () {
        let a = Type.newVariable(new TypeVariable('a')).collectionOf();
        let resolution = Type.newEntity(new Schema({ names: ['Thing'], fields: {} }));
        a.primitiveType().variable.resolution = resolution;
        let c = Type.newEntity(new Schema({ names: ['Product', 'Thing'], fields: {} })).collectionOf();
    ...
    it('doesn\'t resolve a pair of out [~a (is Thing)], inout [Product]', () => __awaiter(this, void 0, void 0, function* () {
        let a = Type.newVariable(new TypeVariable('a')).collectionOf();
        let resolution = Type.newEntity(new Schema({ names: ['Thing'], fields: {} }));
        a.primitiveType().variable.resolution = resolution;
        let c = Type.newEntity(new Schema({ names: ['Product', 'Thing'], fields: {} })).collectionOf();
    ...
    it('resolves inout [~a] (is Thing), in [~b] (is Thing), in [Product], in [~c], in [~d] (is Product)', () => __awaiter(this, void 0, void 0, function* () {
        let a = Type.newVariable(new TypeVariable('a')).collectionOf();
        let b = Type.newVariable(new TypeVariable('b')).collectionOf();
        let resolution = Type.newEntity(new Schema({ names: ['Thing'], fields: {} }));
        a.primitiveType().variable.resolution = resolution;
    ...
    it('doesn\'t depend on ordering in assigning a resolution to a type variable', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('correctly applies then resolves a one-sided Entity constraint', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('does not resolve Entity and Collection', () => __awaiter(this, void 0, void 0, function* () {
        let entity = {
    ...
    it('does not modify an input baseType if invoked through Handle.effectiveType', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('can compare a type variable with a set handle', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('can compare a type variable with a set handle (with constraints)', () => __awaiter(this, void 0, void 0, function* () {
