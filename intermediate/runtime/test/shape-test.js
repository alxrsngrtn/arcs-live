...
describe('shape', function () {
    ...
    it('matches particleSpecs', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('matches particleSpecs with slots', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
        schema Test
    ...
    it('Maybe ensure resolved does not mutate on failure', () => {
        let constrainedType1 = TypeChecker.processTypeList(Type.newVariable({ name: 'a' }), [{
                type: Type.newEntity(new Schema({ names: ['Thing'], fields: {} })),
                direction: 'in'
            }]);
        let constrainedType2 = TypeChecker.processTypeList(Type.newVariable({ name: 'b' }), [{
                type: Type.newEntity(new Schema({ names: ['Thing'], fields: {} })),
                direction: 'out'
            }]);
    ...
    it('restricted type constraints type variables in the recipe', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('allows checking whether particle matches a shape', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing
    ...
    `);
        ...
        assert.isTrue(!!hostedShape.restrictType(manifest.findParticleByName('GuitarCandidate')));
