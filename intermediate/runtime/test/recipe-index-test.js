...
describe('RecipeIndex', function () {
    function createIndex(manifestContent) {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = (yield Manifest.parse(manifestContent));
            ...
            yield arc.recipeIndex.ready;
            return arc.recipeIndex;
        });
    }
    function extractIndexRecipeStrings(manifestContent) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield createIndex(manifestContent)).recipes.map(r => r.toString());
        });
    }
    it('adds use handles', () => __awaiter(this, void 0, void 0, function* () {
        assert.sameMembers(yield extractIndexRecipeStrings(`
      schema Person
      schema Lumberjack
  ...
  Transform as particle0
    ...
    it('matches free handles to connections', () => __awaiter(this, void 0, void 0, function* () {
        assert.sameMembers(yield extractIndexRecipeStrings(`
      schema Person
  ...
  A as particle0
    ...
    it('resolves local slots, but not a root slot', () => __awaiter(this, void 0, void 0, function* () {
        assert.sameMembers(yield extractIndexRecipeStrings(`
      particle A
        consume root
          provide detail
  ...
  B as particle1
    ...
    it('resolves constraints', () => __awaiter(this, void 0, void 0, function* () {
        assert.sameMembers(yield extractIndexRecipeStrings(`
      schema A
      schema B
      schema C
  ...
  TransformAgain as particle1
    ...
    it('does not resolve verbs', () => __awaiter(this, void 0, void 0, function* () {
        assert.sameMembers(yield extractIndexRecipeStrings(`
      particle A &verb
  ...
  &verb`
    ...
    it('exposes multiple recipes', () => __awaiter(this, void 0, void 0, function* () {
        assert.sameMembers(yield extractIndexRecipeStrings(`
      particle A
      particle B
  ...
  &verb`
    ...
    it('finds matching handles by fate', () => __awaiter(this, void 0, void 0, function* () {
        let index = yield createIndex(`
      schema Thing
    ...
    it('finds matching handle by type', () => __awaiter(this, void 0, void 0, function* () {
        let index = yield createIndex(`
      schema Thing
      schema OtherThing
    ...
    it('finds matching handles by tags', () => __awaiter(this, void 0, void 0, function* () {
        let index = yield createIndex(`
      schema Thing
    ...
    it('finds tagged handles if selecting handle is not tagged', () => __awaiter(this, void 0, void 0, function* () {
        let index = yield createIndex(`
      schema Thing
    ...
    it('matching use/create handle pairs require communication', () => __awaiter(this, void 0, void 0, function* () {
        let index = yield createIndex(`
      schema Thing
    ...
    it('matching use/copy handle pairs do not require communication', () => __awaiter(this, void 0, void 0, function* () {
        let index = yield createIndex(`
      schema Thing
