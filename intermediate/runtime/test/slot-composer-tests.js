...
function initSlotComposer(recipeStr) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        planner.init(arc);
        yield planner.strategizer.generate();
...
describe('slot composer', function () {
    it('initialize recipe and render slots', () => __awaiter(this, void 0, void 0, function* () {
        let manifestStr = `
particle A in 'a.js'
  consume root
    provide mySlot
...
recipe
  ...
  C
    consume otherSlot as slot2
        `;
        let { arc, slotComposer, plan, startRenderParticles } = yield initSlotComposer(manifestStr);
        ...
        yield slotComposer.renderSlot(particle, 'root', { model: { 'foo': 'bar' } });
    ...
    it('initialize recipe and render hosted slots', () => __awaiter(this, void 0, void 0, function* () {
        let slotComposer = new SlotComposer({ affordance: 'mock', rootContainer: { 'root': 'dummy-container' } });
