...
function assertRecipeParses(input, result) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let target = (yield Manifest.parse(result)).recipes[0].toString();
        assert.deepEqual((yield Manifest.parse(input)).recipes[0].toString(), target);
    });
}
describe('manifest', function () {
    it('can parse a manifest containing a recipe', () => __awaiter(this, void 0, void 0, function* () {
      ...
      recipe SomeRecipe &someVerb1 &someVerb2
        ...
        verify(yield Manifest.parse(manifest.toString(), {}));
    }));
    it('can parse a manifest containing a particle specification', () => __awaiter(this, void 0, void 0, function* () {
        let schemaStr = `
schema Product
schema Person
    `;
        let particleStr0 = `particle TestParticle in 'testParticle.js'
  in [Product {}] list
  out Person {} person
  affordance dom
  ...
  description \`hello world \${list}\`
    list \`my special list\``;
        let particleStr1 = `particle NoArgsParticle in 'noArgsParticle.js'
  affordance dom`;
        let manifest = yield Manifest.parse(`
${schemaStr}
${particleStr0}
${particleStr1}
    ...
    it('can parse a manifest containing a particle with an argument list', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('SLANDLES can parse a manifest containing a particle with an argument list', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    particle TestParticle in 'a.js'
      in [Product {}] list
      out Person {} person
    ...
    it('can parse a manifest with dependent handles', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    particle TestParticle in 'a.js'
      in [Product {}] input
        out [Product {}] output
    ...
    it('SLANDLES can parse a manifest with dependent handles', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    particle TestParticle in 'a.js'
      in [Product {}] input
        out [Product {}] output
    ...
    it('can round-trip particles with dependent handles', () => __awaiter(this, void 0, void 0, function* () {
  ...
  consume thing
    provide otherThing`;
        let manifest = yield Manifest.parse(manifestString);
        assert.lengthOf(manifest.particles, 1);
        assert.equal(manifestString, manifest.particles[0].toString());
    }));
    it('SLANDLES can round-trip particles with dependent handles', () => __awaiter(this, void 0, void 0, function* () {
        let manifestString = `particle TestParticle in 'a.js'
  in [Product {}] input
    out [Product {}] output
  \`consume Slot thing
  ...
  affordance dom`;
    ...
    it('can parse a manifest containing a schema', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Bar
        Text value`);
    ...
    it('can parse a manifest containing an extended schema', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Foo
        Text value
    ...
    it('two manifests with stores with the same filename, store name and data have the same ids', () => __awaiter(this, void 0, void 0, function* () {
        let manifestA = yield Manifest.parse(`
        store NobId of NobIdStore {Text nobId} in NobIdJson
        resource NobIdJson
          start
          [{"nobId": "12345"}]
        `, { fileName: 'the.manifest' });
        let manifestB = yield Manifest.parse(`
        store NobId of NobIdStore {Text nobId} in NobIdJson
        resource NobIdJson
          start
          [{"nobId": "12345"}]
    ...
    it('two manifests with stores with the same filename and store name but different data have different ids', () => __awaiter(this, void 0, void 0, function* () {
        let manifestA = yield Manifest.parse(`
        store NobId of NobIdStore {Text nobId} in NobIdJson
        resource NobIdJson
          start
    ...
    it('supports recipes with constraints', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema S
      particle A
        in S a
    ...
    it('supports recipes with constraints that reference handles', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A
        out S {} a
    ...
    it('supports recipes with local names', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema S
      particle P1
        out S x
      ...
      recipe
        ...
        P2 as particle0
          x -> thingHandle`);
        let deserializedManifest = (yield Manifest.parse(manifest.toString(), {}));
    }));
    // TODO: move these tests to new-recipe tests.
    it('can normalize simple recipes', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema S
      particle P1
        out S x
      ...
      recipe
        ...
        assert.notEqual(yield recipe1.digest(), yield recipe2.digest());
        recipe1.normalize();
        recipe2.normalize();
        assert.deepEqual(recipe1.toString(), recipe2.toString());
        assert.equal(yield recipe1.digest(), yield recipe2.digest());
        let deserializedManifest = yield Manifest.parse(manifest.toString(), {});
    }));
    it('can normalize recipes with interdependent ordering of handles and particles', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema S
      particle P1
        out S x
    ...
    it('can resolve recipe particles defined in the same manifest', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Something
      schema Someother
    ...
    it('treats a failed import as non-fatal', () => __awaiter(this, void 0, void 0, function* () {
        let manifests = {
            a: `import 'b'`,
            b: `lol what is this`,
        };
        ...
        yield Manifest.load('a', loader);
    }));
    it('throws an error when a particle has invalid description', () => __awaiter(this, void 0, void 0, function* () {
        try {
            let manifest = yield Manifest.parse(`
        schema Foo
        particle Thing in 'thing.js'
    ...
    it('can load a manifest via a loader', () => __awaiter(this, void 0, void 0, function* () {
        let registry = {};
        let loader = {
            loadResource() {
                return 'recipe';
        ...
        let manifest = yield Manifest.load('some-path', loader, { registry });
        assert(manifest.recipes[0]);
        assert.equal(manifest, yield registry['some-path']);
    }));
    it('can load a manifest with imports', () => __awaiter(this, void 0, void 0, function* () {
        let registry = {};
        let loader = {
            loadResource(path) {
                return {
        ...
        let manifest = yield Manifest.load('a', loader, { registry });
        assert.equal(yield registry.a, manifest);
        assert.equal(manifest.imports[0], yield registry.b);
    }));
    it('can resolve recipe particles imported from another manifest', () => __awaiter(this, void 0, void 0, function* () {
        let registry = {};
        let loader = {
            loadResource(path) {
                return {
        ...
        let manifest = yield Manifest.load('a', loader, { registry });
        assert.isTrue(manifest.recipes[0].particles[0].spec.equals((yield registry.b).findParticleByName('ParticleB')));
    }));
    it('can parse a schema extending a schema in another manifest', () => __awaiter(this, void 0, void 0, function* () {
        let registry = {};
        let loader = {
            loadResource(path) {
                return {
    ...
    it('can find all imported recipes', () => __awaiter(this, void 0, void 0, function* () {
        let loader = {
            loadResource(path) {
                return {
                    a: `
        ...
        let manifest = yield Manifest.load('a', loader);
        assert.lengthOf(manifest.recipes, 3);
    }));
    it('can parse a schema with union typing', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Foo
        (Text or URL) u
        Text test
    ...
    it('can parse a manifest containing a recipe with slots', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing
    ...
    it('SLANDLES can parse a manifest containing a recipe with slots', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing
      particle SomeParticle in 'some-particle.js'
        in Thing someParam
    ...
    it('unnamed consume slots', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle SomeParticle &work in 'some-particle.js'
        consume slotA
    ...
    it('SLANDLES unnamed consume slots', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle SomeParticle &work in 'some-particle.js'
        \`consume Slot slotA
      particle SomeParticle1 &rest in 'some-particle.js'
    ...
    it('multiple consumed slots', () => __awaiter(this, void 0, void 0, function* () {
        let parseRecipe = (args) => __awaiter(this, void 0, void 0, function* () {
      ...
      `)).recipes[0];
        ...
        yield parseRecipe({ isRequiredSlotA: false, isRequiredSlotB: false, expectedIsResolved: true });
        yield parseRecipe({ isRequiredSlotA: true, isRequiredSlotB: false, expectedIsResolved: true });
        yield parseRecipe({ isRequiredSlotA: false, isRequiredSlotB: true, expectedIsResolved: false });
        yield parseRecipe({ isRequiredSlotA: true, isRequiredSlotB: true, expectedIsResolved: false });
    }));
    it('SLANDLES multiple consumed slots', () => __awaiter(this, void 0, void 0, function* () {
        let parseRecipe = (args) => __awaiter(this, void 0, void 0, function* () {
            let recipe = (yield Manifest.parse(`
        particle SomeParticle in 'some-particle.js'
    ...
    it('recipe slots with tags', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle SomeParticle in 'some-particle.js'
        consume slotA #aaa
          provide slotB #bbb
    ...
    it('recipe slots with different names', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('recipe provided slot with no local name', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle ParticleA in 'some-particle.js'
        consume slotA1
          provide slotA2
    ...
    it('incomplete aliasing', () => __awaiter(this, void 0, void 0, function* () {
        let recipe = (yield Manifest.parse(`
    ...
    it('relies on the loader to combine paths', () => __awaiter(this, void 0, void 0, function* () {
        let registry = {};
        let loader = {
            loadResource(path) {
                return {
        ...
        let manifest = yield Manifest.load('somewhere/a', loader, { registry });
        assert(registry['somewhere/a path/b']);
    }));
    it('parses all particles manifests', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('loads entities from json files', () => __awaiter(this, void 0, void 0, function* () {
        let manifestSource = `
        schema Thing
        ...
        let manifest = yield Manifest.load('the.manifest', loader);
        let store = manifest.findStoreByName('Store0');
        assert(store);
        assert.deepEqual(yield store.toList(), [
            {
    ...
    it('throws an error when a store has invalid json', () => __awaiter(this, void 0, void 0, function* () {
        try {
            let manifest = yield Manifest.parse(`
      schema Thing
      resource EntityList
...
Error parsing JSON from 'EntityList' (Unexpected token h in JSON at position 1)'
    ...
    it('loads entities from a resource section', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing
    ...
    it('resolves store names to ids', () => __awaiter(this, void 0, void 0, function* () {
        let manifestSource = `
        schema Thing
        store Store0 of [Thing] in 'entities.json'
        recipe
    ...
    it('has prettyish syntax errors', () => __awaiter(this, void 0, void 0, function* () {
        try {
            yield Manifest.parse('recipe ?', { fileName: 'bad-file' });
            assert(false);
        }
        catch (e) {
...
Expected " ", "&", "//", "\\n", "\\r", [ ], or [A-Z] but "?" found.
  recipe ?
    ...
    it('errors when the manifest connects a particle incorrectly', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = `
        schema Thing
    ...
    it('errors when the manifest references a missing particle param', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = `
        schema Thing
        particle TestParticle in 'tp.js'
          in Thing a
    ...
    it('errors when the manifest references a missing consumed slot', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = `
        particle TestParticle in 'tp.js'
          consume root
        recipe
    ...
    it('errors when the manifest references a missing provided slot', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = `
        particle TestParticle in 'tp.js'
          consume root
            provide action
    ...
    it('errors when the manifest uses invalid connection constraints', () => __awaiter(this, void 0, void 0, function* () {
        // nonexistent fromParticle
        let manifestFrom = `
        recipe
          NoParticle.paramA -> OtherParticle.paramB`;
        try {
            yield Manifest.parse(manifestFrom);
            assert.fail();
        }
        catch (e) {
        ...
        try {
            yield Manifest.parse(manifestTo);
            assert.fail();
        }
        catch (e) {
        ...
        try {
            yield Manifest.parse(manifestFromParam);
            assert.fail();
        }
        catch (e) {
        ...
        recipe
          ParticleA.paramA -> ParticleB.paramB`;
        try {
            yield Manifest.parse(manifestToParam);
            assert.fail();
        }
        catch (e) {
    ...
    it('resolves manifest with recipe with search', () => __awaiter(this, void 0, void 0, function* () {
        // TODO: support search tokens in manifest-parser.peg
        let manifestSource = `
      recipe
        search \`Hello dear world\``;
        let recipe = (yield Manifest.parse(manifestSource)).recipes[0];
  ...
  search \`Hello dear world\`
    tokens \`dear\` \`hello\` \`world\``);
        recipe = (yield Manifest.parse(manifestSource)).recipes[0];
        // resolve some tokens.
  ...
  search \`Hello dear world\`
    ...
    it('merge recipes with search strings', () => __awaiter(this, void 0, void 0, function* () {
        let recipe1 = (yield Manifest.parse(`recipe
  search \`Hello world\``)).recipes[0];
        let recipe2 = (yield Manifest.parse(`recipe
  search \`good morning\`
    ...
    it('can parse a manifest containing stores', () => __awaiter(this, void 0, void 0, function* () {
        let loader = {
            loadResource() {
                return '[]';
            },
  ...
  store ClairesWishlist of [Product] #wishlist in 'wishlist.json'
    description \`Claire's wishlist\``, { loader });
        ...
        verify(manifest);
        verify(yield Manifest.parse(manifest.toString(), { loader }));
    }));
    it('can parse a manifest containing resources', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
resource SomeName
  start
  {'foo': 'bar'}
...
`, {});
    ...
    it('can parse a manifest containing incomplete shapes', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Foo
      shape FullShape
        in Foo foo
    ...
    it('can parse a manifest containing shapes', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Foo
      shape Shape
        in Foo foo
    ...
    it('can parse shapes using new-style body syntax', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Foo
      shape Shape
        in Foo foo
    ...
    it('can resolve optional handles', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Something
      particle Thing in 'thing.js'
    ...
    it('can resolve an immediate handle specified by a particle target', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema S
      shape HostedShape
        in S foo
    ...
    it('can resolve a particle with an inline schema', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle P
        in * {Text value} foo
      recipe
    ...
    it('can resolve inline schemas against out of line schemas', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema T
        Text value
      particle P
    ...
    it('can resolve handle types from inline schemas', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle P
        in * {Text value} foo
      particle P2
    ...
    it('can infer field types of inline schemas from external schemas', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing
        Text value
      particle P
    ...
    it('supports inline schemas with multiple names', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing1
        Text value1
      schema Thing2
    ...
    it('can parse a manifest with storage key handle definitions', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Bar
        Text value
    ...
    it('can process a schema alias', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('expands schema aliases', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('fails when expanding conflicting schema aliases', () => __awaiter(this, void 0, void 0, function* () {
        try {
            let manifest = yield Manifest.parse(`
        alias schema Name1 as Thing1
          Text field1
    ...
    it('fails when inline schema specifies a field type that does not match alias expansion', () => __awaiter(this, void 0, void 0, function* () {
        try {
            let manifest = yield Manifest.parse(`
        alias schema Name1 as Thing1
          Text field1
    ...
    it('can relate inline schemas to generic connections', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing
        Text value
        Number num
    ...
    it('can parse a recipe with slot constraints on verbs', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      recipe
        &verb
          consume consumeSlot
    ...
    it('can parse particle arguments with tags and optional names', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Dog
      schema Sled
      schema DogSled
    ...
    it('can parse recipes with an implicit create handle', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A
        out S {} a
      particle B
