...
describe('schema', function () {
    ...
    it('schemas load recursively', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
    ...
    it('stores a copy of the constructor arguments', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Product = manifest.findSchemaByName('Product').entityClass();
    ...
    it('has accessors for all schema fields', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Product = manifest.findSchemaByName('Product').entityClass();
    ...
    it('has accessors for schema fields only', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Product = manifest.findSchemaByName('Product').entityClass();
    ...
    it('performs type checking', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Product = manifest.findSchemaByName('Product').entityClass();
    ...
    it('makes a copy of the data when cloning', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Product = manifest.findSchemaByName('Product').entityClass();
    ...
    it('field with a single parenthesised value is a tuple not a union', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.parse(`
    ...
    it('handles schema unions', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
    ...
    it('handles field type conflict in schema unions', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Person = manifest.findSchemaByName('Person');
    ...
    it('handles schema intersection of subtypes', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
    ...
    it('handles schema intersection for shared supertypes', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Thing = manifest.findSchemaByName('Thing');
            let Product = manifest.findSchemaByName('Product');
    ...
    it('handles schema intersection if no shared supertype and a conflicting field', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Product = manifest.findSchemaByName('Product');
            let Person = manifest.findSchemaByName('Person');
    ...
    it('handles empty schema intersection as empty object', function () {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.load('Product.schema', loader);
            let Person = manifest.findSchemaByName('Person');
