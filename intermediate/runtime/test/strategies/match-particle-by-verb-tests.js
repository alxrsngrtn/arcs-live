...
describe('MatchParticleByVerb', function () {
    ...
    recipe
      ...
      &jump
        ...
        * <- energy
  `;
    it('particles by verb strategy', () => __awaiter(this, void 0, void 0, function* () {
        ...
        let results = yield mpv.generate(inputParams);
    ...
    it('particles by verb recipe fully resolved', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = (yield Manifest.parse(manifestStr));
