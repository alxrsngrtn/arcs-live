...
describe('CreateHandleGroup', function () {
    it('connects variables and inline schemas', () => __awaiter(this, void 0, void 0, function* () {
      ...
      recipe
        ...
        Employ
    `);
        let result = yield StrategyTestHelper.onlyResult(null, CreateHandleGroup, manifest.recipes[0]);
        assert.lengthOf(result.handles, 1);
        assert.equal(result.handles[0].fate, 'create');
        assert.isTrue(result.isResolved());
    }));
    it('requires read-write connection between particles', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Human
        Text name
      schema Child extends Human
      ...
      recipe
        ...
        Employ
    `);
        assert.isEmpty(yield StrategyTestHelper.theResults(null, CreateHandleGroup, manifest.recipes[0]));
    }));
    it('does not connect a single particle', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Human
        Text name
    ...
    it('connects the biggest groups available', () => __awaiter(this, void 0, void 0, function* () {
