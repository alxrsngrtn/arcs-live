...
describe('MatchRecipeByVerb', function () {
    it('removes a particle and adds a recipe', () => __awaiter(this, void 0, void 0, function* () {
    ...
    `);
        ...
        let results = yield mrv.generate(inputParams);
        assert.lengthOf(results, 1);
        assert.isEmpty(results[0].result.particles);
        assert.deepEqual(results[0].result.toString(), 'recipe &jump\n  JumpingBoots.e <- NuclearReactor.e\n  JumpingBoots.f <- FootFactory.f');
    }));
    it('plays nicely with constraints', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema S
      particle P in 'A.js'
        out S p
    ...
    `);
        ...
        results = yield cctc.generate({ generated: results });
        assert.lengthOf(results, 1);
  ...
  Q as particle1
    ...
    it('listens to handle constraints', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    particle P in 'A.js'
      out S {} a
    ...
    `);
        ...
        results = yield mrv.generate(inputParams);
    ...
    it('listens to slot constraints', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle P in 'A.js'
        consume foo
          provide bar
    ...
    it('carries handle assignments across verb substitution', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('carries handle assignments across verb substitution with generic binding', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('selects the appropriate generic binding when handle assignments carry type information', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    ...
    it('carries slot assignments across verb substitution', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle P in 'A.js'
        consume foo
          provide bar  
    ...
    it('carries slot assignments across when they\'re assigned elsewhere too', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
    particle P in 'A.js'
      consume foo
        provide bar  
