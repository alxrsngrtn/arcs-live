...
describe('SearchTokensToParticles', function () {
    it('matches particles by verb strategy', () => __awaiter(this, void 0, void 0, function* () {
    ...
    `));
        ...
        let results = yield stp.generate(inputParams);
    ...
    it('matches particles by split verb', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = (yield Manifest.parse(`
    ...
    it('matches recipes by split verb', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = (yield Manifest.parse(`
      particle GalaxyRunner &run in 'AA.js'
    ...
    it('matches recipes by verb strategy', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = (yield Manifest.parse(`
      particle SimpleJumper &jump in 'A.js'
