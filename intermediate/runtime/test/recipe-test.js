...
describe('recipe', function () {
    it('normalize errors', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('clones recipe', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
        particle Particle1
        recipe MyRecipe
          Particle1
    ...
    it('validate handle connection types', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
        schema MyType
    ...
    it('keeps orphaned slots, handles and particles', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A in 'A.js'
    ...
    it(`is resolved if an optional handle with dependents is not connected`, () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A in 'A.js'
        in [Foo {}]? optionalIn
    ...
    it(`is not resolved if a handle is connected but its parent isn't`, () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A in 'A.js'
        in [Foo {}]? optionalIn
          out [Foo {}] dependentOut
    ...
    it(`is not resolved if a handle type is not resolved`, () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A in 'B.js'
        in ~a foo1
        in ~a foo2
    ...
    const getFirstRecipeHash = (manifestContent) => __awaiter(this, void 0, void 0, function* () {
        let loader = new Loader();
        let manifest = yield Manifest.parse(manifestContent, { loader, fileName: './manifest.manifest' });
        let [recipe] = manifest.recipes;
        assert.isTrue(recipe.normalize());
        return recipe.digest();
    });
    it('generates the same hash on manifest re-parse for immediates', () => __awaiter(this, void 0, void 0, function* () {
      ...
      recipe
        A
          hostedParticle <- B
    `;
        const digestA = yield getFirstRecipeHash(manifestContent);
        const digestB = yield getFirstRecipeHash(manifestContent);
        assert.equal(digestA, digestB);
    }));
    it('generates the same hash on manifest re-parse for stores', () => __awaiter(this, void 0, void 0, function* () {
        const manifestContent = `
    ...
    it('generates the same hash on manifest re-parse for stores of collections', () => __awaiter(this, void 0, void 0, function* () {
        const manifestContent = `
      store NobId of [NobIdStore {Text nobId}] in NobIdJson
       resource NobIdJson
         start
    ...
    it('verifies required consume and provide slot connections', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A
        must consume slotA
          must provide slotA1
    ...
    it('verifies required consume connection is provided by a fullfilled slot', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      particle A
        consume slot1
          must provide slot2
    ...
    it('considers type resolution as recipe update', () => __awaiter(this, void 0, void 0, function* () {
        let manifest = yield Manifest.parse(`
      schema Thing
      particle Generic
        in ~a any
  ...
  Specific as particle1
    thing <- handle0`, recipe.toString({ showUnresolved: true }));
        let hash = yield recipe.digest();
        let recipeClone = recipe.clone();
        let hashClone = yield recipeClone.digest();
        ...
        let hashResolvedClone = yield recipeClone.digest();
        assert.equal(`recipe
