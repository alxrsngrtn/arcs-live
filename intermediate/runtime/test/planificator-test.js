...
class TestPlanificator extends Planificator {
    ...
    _schedulePlanning(timeout) {
        const _super = name => super[name];
        return __awaiter(this, void 0, void 0, function* () {
            ++this.scheduleCount;
            this.schedulePromises.push(_super("_schedulePlanning").call(this, timeout));
        });
    }
    _cancelPlanning() {
        this.plannerPromise = null;
...
describe('Planificator', function () {
    ...
    it('makes replanning requests', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        for (let i = 0; i < 10; ++i) {
        ...
        yield planificator.allPlanningDone();
        assert.isFalse(planificator.isPlanning);
        let { plans } = planificator.getCurrentPlans();
    ...
    it('replans triggered by data change', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        assert.isFalse(planificator.isPlanning);
        // Trigger replanning
        ...
        yield new Promise((resolve, reject) => setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(); }), 300));
        assert.isTrue(planificator.isPlanning);
    ...
    it('groups data change triggered replanning', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        // Add 3 data change events with intervals.
        planificator._arc._onDataChange();
        yield new Promise((resolve, reject) => setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(); }), 100));
        planificator._arc._onDataChange();
        yield new Promise((resolve, reject) => setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(); }), 100));
        planificator._arc._onDataChange();
        ...
        yield new Promise((resolve, reject) => setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(); }), 250));
        assert.isTrue(planificator.isPlanning);
    }));
    it('caps replanning delay with max-no-replan value', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator({ defaultReplanDelayMs: 100, maxNoReplanMs: 110 });
        // Add 3 data change events with intervals.
        planificator._arc._onDataChange();
        yield new Promise((resolve, reject) => setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(); }), 10));
        planificator._arc._onDataChange();
        yield new Promise((resolve, reject) => setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(); }), 40));
        planificator._arc._onDataChange();
        assert.lengthOf(planificator._dataChangesQueue._changes, 3);
        assert.isNotNull(planificator._dataChangesQueue._replanTimer);
        assert.isFalse(planificator.isPlanning);
        // Wait and verify planning has started.
        yield new Promise((resolve, reject) => setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(); }), 70));
        assert.isTrue(planificator.isPlanning);
    }));
    it('cancels data change triggered replanning if other replanning occured', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        let plan = new Recipe();
        plan.normalize();
        ...
        yield planificator._arc.instantiate(plan);
        assert.isTrue(planificator.isPlanning);
        assert.isEmpty(planificator._dataChangesQueue._changes);
        assert.isNull(planificator._dataChangesQueue._replanTimer);
    }));
    it('delays data triggered replanning if planning is in progress', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
    ...
    it('replans triggered by plan instantiation', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        planificator._requestPlanning();
        let plan = planificator.plannerReturnFakeResults(['test'])[0].plan;
        yield planificator.allPlanningDone();
    ...
    it('triggers plan and state changed callbacks', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        let stateChanged = 0;
        let planChanged = 0;
    ...
    it('retrieves and filters suggestions', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        planificator._requestPlanning();
        let plans = [];
    ...
    it('shows suggestions involving handle from active recipe', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('controls contextual planning', () => __awaiter(this, void 0, void 0, function* () {
        let planificator = createPlanificator();
        ...
        plan.plan.normalize();
        yield planificator._arc.instantiate(plan.plan);
        assert.isTrue(planificator.isPlanning);
        ...
        planificator.setSearch('*');
        assert.isTrue(planificator.isPlanning);
        assert.isFalse(planificator.plannerOptions.strategyArgs.contextual, 'once search term is entered, planning should again become contextual');
