...
export class RecipeIndex {
    constructor(context, affordance) {
        ...
        this.ready = trace.endWith(new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            let generations = [];
            do {
                let record = yield strategizer.generate();
            ...
            if (DevtoolsConnection.isConnected) {
                StrategyExplorerAdapter.processGenerations(generations, DevtoolsConnection.get(), { label: 'Index', keep: true });
            }
