...
export class SlotDomConsumer extends SlotConsumer {
    ...
    _validateSubId(providedSlotSpec, subId) {
        ...
        assert(Boolean(this.subId || subId) === providedSlotSpec.isSet, `Sub-id ${subId} for provided slot ${providedSlotSpec.name} doesn't match set spec: ${providedSlotSpec.isSet}`);
    }
    ...
    _initMutationObserver() {
        if (this.consumeConn) {
            return new MutationObserver((records) => __awaiter(this, void 0, void 0, function* () {
