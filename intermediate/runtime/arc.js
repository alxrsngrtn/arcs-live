...
${this.activeRecipe.toString()}`;
    ...
    static deserialize({ serialization, pecFactory, slotComposer, loader, fileName, context }) {
        return __awaiter(this, void 0, void 0, function* () {
            let manifest = yield Manifest.parse(serialization, { loader, fileName, context });
            let arc = new Arc({
    ...
    cloneForSpeculativeExecution() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let handle of this._stores) {
                let clone = yield arc._storageProviderFactory.construct(handle.id, handle.type, 'in-memory');
                yield clone.cloneFrom(handle);
