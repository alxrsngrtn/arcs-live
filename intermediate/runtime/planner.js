...
export class Planner {
    ...
    plan(timeout, generations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let start = now();
            do {
                let record = yield trace.wait(this.strategizer.generate());
    ...
    suggest(timeout, generations, speculator) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!generations && DevtoolsConnection.isConnected)
                generations = [];
            let plans = yield trace.wait(this.plan(timeout, generations));
            let suggestions = [];
            ...
            let results = yield trace.wait(Promise.all(planGroups.map((group, groupIndex) => __awaiter(this, void 0, void 0, function* () {
                let results = [];
                for (let plan of group) {
                    let hash = ((hash) => { return hash.substring(hash.length - 4); })(yield plan.digest());
                    ...
                    let relevance = yield speculator.speculate(this._arc, plan, hash);
                    ...
                    let description = yield relevance.newArc.description.getRecipeSuggestion();
