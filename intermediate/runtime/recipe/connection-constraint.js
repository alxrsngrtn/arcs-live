...
export class ParticleEndPoint {
    ...
    _compareTo(other) {
        let cmp;
        if ((cmp = util.compareStrings(this.particle.name, other.particle.name)) != 0)
            return cmp;
        if ((cmp = util.compareStrings(this.connection, other.connection)) != 0)
            return cmp;
        return 0;
    }
    toString() {
...
export class InstanceEndPoint {
    ...
    _compareTo(other) {
        let cmp;
        if ((cmp = this.instance._compareTo(other.instance)) != 0)
            return cmp;
        if ((cmp = util.compareStrings(this.connection, other.connection)) != 0)
            return cmp;
        return 0;
...
export class HandleEndPoint {
    ...
    _compareTo(other) {
        let cmp;
        if ((cmp = util.compareStrings(this.handle.localName, other.handle.localName)) != 0)
            return cmp;
        return 0;
    }
    toString() {
...
export class TagEndPoint {
    ...
    _compareTo(other) {
        let cmp;
        if ((cmp = util.compareArrays(this.handle.tags, other.handle.tags, util.compareStrings)) != 0)
            return cmp;
        return 0;
    }
    toString() {
...
export class ConnectionConstraint {
    ...
    _compareTo(other) {
        ...
        if ((cmp = this.to._compareTo(other.to)) != 0)
            return cmp;
        if ((cmp = util.compareStrings(this.direction, other.direction)) != 0)
            return cmp;
        return 0;
    }
