...
export class SlotConsumer {
    ...
    setContent(content, handler, arc) {
        return __awaiter(this, void 0, void 0, function* () {
            if (content && Object.keys(content).length > 0) {
                if (arc) {
                    content.descriptions = yield this.populateHandleDescriptions(arc);
                }
            }
    ...
    populateHandleDescriptions(arc) {
        return __awaiter(this, void 0, void 0, function* () {
            let descriptions = {};
            yield Promise.all(Object.values(this.consumeConn.particle.connections).map((handleConn) => __awaiter(this, void 0, void 0, function* () {
                if (handleConn.handle) {
                    descriptions[`${handleConn.name}.description`] = (yield arc.description.getHandleDescription(handleConn.handle)).toString();
                }
            })));
            return descriptions;
        });
