...
export class Strategizer {
    ...
    generate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let generated = yield Promise.all(this._strategies.map(strategy => {
            ...
            generated = yield Promise.all(generated.map((result) => __awaiter(this, void 0, void 0, function* () {
                if (result.hash)
            ...
            // Evalute
            let evaluations = yield Promise.all(this._evaluators.map(strategy => {
...
export class Strategy {
    ...
    evaluate(strategizer, individuals) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _transitiveClosureFor(strategy, beingExpanded, alreadyExpanded) {
        ...
        if (followingStrategies) {
            ...
            for (let following of followingStrategies) {
                for (let expanded of this._transitiveClosureFor(following, beingExpanded, alreadyExpanded)) {
