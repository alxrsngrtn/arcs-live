...
import { FlowGraph, Node, CheckResultType, BackwardsPath } from '../dataflow/flow-graph.js';
...
describe('BackwardsPath', () => {
    ...
    it('starts with a single open edge', () => {
        ...
        assert.sameOrderedMembers(path.nodes, [nodeB]);
    ...
    it('can add an open edge to the end of a closed path', () => {
        ...
        assert.sameOrderedMembers(path.nodes, [nodeC, nodeB]);
        assert.equal(path.openEdge, edgeAToB);
...
//# sourceMappingURL=flow-graph-tests.js.map