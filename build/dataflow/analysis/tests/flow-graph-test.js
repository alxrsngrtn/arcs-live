    ...
    describe('references', () => {
        ...
        recipe R
          P
            ...
            outRef -> h3
      `);
            const outEdge = graph.edges.find(e => e instanceof ParticleOutput);
      ...
      `);
        ...
        recipe R
          P
            ...
            outFoo -> h3
      `);
            const outEdge = graph.edges.find(e => e instanceof ParticleOutput && e.label === 'P.outRef');
            assert.lengthOf(outEdge.derivesFrom, 1);
      ...
      `);
        ...
        recipe R
          P
            ...
            outRef2 -> h2
      `);
            const outEdge = graph.edges.find(e => e instanceof ParticleOutput && e.label === 'P.outRef1');
