...
import { StreamMessageReader as VSCodeStreamMessageReader, StreamMessageWriter as VSCodeStreamMessageWriter, } from 'vscode-jsonrpc';
import { AmlService } from './aml-service.js';
import { DevNullLogger } from './util.js';
function createReader(id, inS, outS, options, logger) {
