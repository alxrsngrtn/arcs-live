...
import { jsonrpc, camelCase } from './util.js';
export class AmlService {
    constructor(reader, writer, options, logger) {
        this.initialized = false; // error / onclose should trigger shutdown message.
        this.streaming = false; // Client supports partialResult.
        this.reader = reader;
        this.writer = writer;
        this.context = { logger, options };
        this.reader.listen(message => {
            this.update(message).then((response) => {
