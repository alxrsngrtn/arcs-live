...
export class ExplorerProxy {
    constructor() {
        this.device = null;
        this.explorer = null;
        this.onceDeviceAppearsResolve = () => { };
        this.onceDeviceAppears = new Promise(resolve => this.onceDeviceAppearsResolve = resolve);
    }
    listen(server, explorePort) {
        new WebSocket.Server({ server }).on('connection', ws => {
            ...
            ws.on('error', e => {
                ...
                this.onceDeviceAppears = new Promise(resolve => this.onceDeviceAppearsResolve = resolve);
                if (this.explorer)
                    this.explorer.send('disconnected');
...
//# sourceMappingURL=explorer-proxy.js.map