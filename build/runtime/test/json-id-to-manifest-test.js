...
describe('JsonldToManifest', () => {
    ...
    const omitKey = (obj, key) => messyOmit(obj, (kv) => kv[0] === key);
    describe('convert', () => {
        ...
        it.skip('should produce a manifest even if there are no relevant properties', async () => {
            const omitSupportedRangeIncludes = (obj, target) => messyOmit(obj, (kv) => {
                const key = kv[0];
...
//# sourceMappingURL=json-id-to-manifest-test.js.map