...
export declare type ParticleCheckCondition = ParticleCheckHasTag | ParticleCheckIsFromHandle | ParticleCheckIsFromOutput | ParticleCheckIsFromStore;
...
export declare type DirectionUnified = 'reads' | 'writes' | 'reads writes' | 'hosts' | '`consumes' | '`provides' | 'any';
export declare type DirectionArrow = '<-' | '->' | '<->' | '`consume' | '`provide' | '=';
export declare function preSlandlesDirectionToDirection(direction: Direction, isOptional?: boolean): string;
export declare function directionToPreSlandlesDirection(direction: DirectionUnified): Direction;
