...
describe('Arc new storage', () => {
    it('preserves data when round-tripping through serialization', Flags.withNewStorageStack(async () => {
      ...
      `
        ...
        const varHandle2 = await handleNGFor('crdt-key', varStorageProxy2, arc.idGeneratorForTesting, null, true, true, 'varHandle');
        const colStorageProxy2 = new StorageProxyNG('id-2', await colStore2.activate(), dataClass.type.collectionOf());
        const colHandle2 = await handleNGFor('crdt-key-2', colStorageProxy2, arc.idGeneratorForTesting, null, true, true, 'colHandle');
