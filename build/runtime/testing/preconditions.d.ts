 ...
 */
export declare function checkDefined<T>(value: T | null | undefined, customMessage?: string): T;
/**
 ...
 * @throws when value is undefined or null.
 */
export declare function checkNotNull<T>(value: T | null, customMessage?: string): T;
