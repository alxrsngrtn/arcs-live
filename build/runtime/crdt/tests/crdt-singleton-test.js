...
describe('CRDTSingleton', () => {
    ...
    it('can add and clear from multiple actors', () => {
        ...
        assert.deepEqual(singleton.getData().values, { '1': { value: { id: '1' }, version: { A: 1 } } });
        assert.deepEqual(singleton.getParticleView(), { id: '1' });
        ...
        assert.deepEqual(singleton.getData().values, { '1': { value: { id: '1' }, version: { A: 1 } }, '2': { value: { id: '2' }, version: { B: 1 } } });
        assert.deepEqual(singleton.getParticleView(), { id: '1' });
        ...
        assert.deepEqual(singleton.getData().values, { '2': { value: { id: '2' }, version: { A: 1, B: 2 } } });
        assert.deepEqual(singleton.getParticleView(), { id: '2' });
        singleton.applyOperation({
            type: SingletonOpTypes.Clear,
            actor: 'A',
