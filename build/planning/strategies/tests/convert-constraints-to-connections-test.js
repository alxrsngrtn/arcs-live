...
describe('ConvertConstraintsToConnections', () => {
  ...
  B as particle1
    ...
    `);
        ...
        assert.strictEqual(recipe.obligations[0].from.instance, recipe.particles[0]);
        assert.strictEqual(recipe.obligations[0].to.instance, recipe.particles[1]);
    });
...
//# sourceMappingURL=convert-constraints-to-connections-test.js.map