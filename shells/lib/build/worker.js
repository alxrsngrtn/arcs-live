...
/* harmony import */ var _storageNG_handle_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class UiParticleBase extends _particle_js__WEBPACK_IMPORTED_MODULE_2__["Particle"] {
    ...
    async set(handleName, value) {
        ...
        if (!(handle instanceof _handle_js__WEBPACK_IMPORTED_MODULE_1__["Singleton"]) && !(handle instanceof _storageNG_handle_js__WEBPACK_IMPORTED_MODULE_3__["SingletonHandle"])) {
    ...
    async add(handleName, value) {
        const handle = this._requireHandle(handleName);
        if (!(handle instanceof _handle_js__WEBPACK_IMPORTED_MODULE_1__["Collection"]) && !(handle instanceof _storageNG_handle_js__WEBPACK_IMPORTED_MODULE_3__["CollectionHandle"])) {
        ...
        return this.await(async (p) => {
            ...
            if (handle instanceof _storageNG_handle_js__WEBPACK_IMPORTED_MODULE_3__["CollectionHandle"]) {
    ...
    _requireEntity(value, entityClass, id) {
    ...
    async clear(handleName) {
        ...
        if (!(handle instanceof _handle_js__WEBPACK_IMPORTED_MODULE_1__["Singleton"]) && !(handle instanceof _handle_js__WEBPACK_IMPORTED_MODULE_1__["Collection"]) &&
            !(handle instanceof _storageNG_handle_js__WEBPACK_IMPORTED_MODULE_3__["SingletonHandle"]) && !(handle instanceof _storageNG_handle_js__WEBPACK_IMPORTED_MODULE_3__["CollectionHandle"])) {
