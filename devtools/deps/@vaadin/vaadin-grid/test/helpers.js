/// BareSpecifier=@vaadin/vaadin-grid/test/helpers
/**
@license
...
window.flushColumns = grid => {
  Array.prototype.forEach.call(grid.querySelectorAll('vaadin-grid-column, vaadin-grid-column-group'), col => col._templateObserver.flush());
};
