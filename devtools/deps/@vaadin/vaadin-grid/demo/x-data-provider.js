/// BareSpecifier=@vaadin/vaadin-grid/demo/x-data-provider
      ...
      dataProvider: {
        ...
        value: () => {
          ...
          return (params, callback) => {
            const items = Array.apply(null, { length: params.pageSize }).map((item, index) => getJSON('http://randomuser.me?index=' + (index + params.page * params.pageSize)));
            _this.loading = true;
            setTimeout(() => {
              callback(items);
              _this.loading = false;
