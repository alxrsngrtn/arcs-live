/// BareSpecifier=vis/dist/vis-timeline-graph2d.min
/**
 * vis.js
...
!function (t, e) {
  ...
  return function (t) {
    ...
    function o(t) {
      ...
      var o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];for (var s in t) void 0 !== i[s] && (null === i[s] || "object" !== (0, p.default)(i[s]) ? n(t, i, s, o) : "object" === (0, p.default)(t[s]) && e.fillIfDefined(t[s], i[s], o));
    }, e.extend = function (t, e) {
      for (var i = 1; i < arguments.length; i++) {
        var o = arguments[i];for (var n in o) o.hasOwnProperty(n) && (t[n] = o[n]);
      }return t;
    }, e.selectiveExtend = function (t, e, i) {
      if (!Array.isArray(t)) throw new Error("Array with property names expected as first argument");for (var o = 2; o < arguments.length; o++) for (var n = arguments[o], s = 0; s < t.length; s++) {
      ...
      var s = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];if (Array.isArray(o)) throw new TypeError("Arrays are not supported by deepExtend");for (var r in o) if (o.hasOwnProperty(r) && -1 === t.indexOf(r)) if (o[r] && o[r].constructor === Object) void 0 === i[r] && (i[r] = {}), i[r].constructor === Object ? e.deepExtend(i[r], o[r]) : n(i, o, r, s);else if (Array.isArray(o[r])) {
        i[r] = [];for (var a = 0; a < o[r].length; a++) i[r].push(o[r][a]);
      } else n(i, o, r, s);return i;
    }, e.deepExtend = function (t, i) {
      var o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
          s = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];for (var r in i) if (i.hasOwnProperty(r) || !0 === o) if (i[r] && i[r].constructor === Object) void 0 === t[r] && (t[r] = {}), t[r].constructor === Object ? e.deepExtend(t[r], i[r], o) : n(t, i, r, s);else if (Array.isArray(i[r])) {
        t[r] = [];for (var a = 0; a < i[r].length; a++) t[r].push(i[r][a]);
      } else n(t, i, r, s);return t;
    }, e.equalArray = function (t, e) {
      if (t.length != e.length) return !1;for (var i = 0, o = t.length; i < o; i++) if (t[i] != e[i]) return !1;return !0;
      ...
      for (var i = [], o = 0; o < t.length; o++) i.push(t[o]);return i.push(e), i;
    }, e.copyArray = function (t) {
      for (var e = [], i = 0; i < t.length; i++) e.push(t[i]);return e;
      ...
      var i, o;if (Array.isArray(t)) for (i = 0, o = t.length; i < o; i++) e(t[i], i, t);else for (i in t) t.hasOwnProperty(i) && e(t[i], i, t);
    }, e.toArray = function (t) {
      var e = [];for (var i in t) t.hasOwnProperty(i) && e.push(t[i]);return e;
      ...
      var i = g.split(t.style.cssText),
          o = g.split(e);for (var n in o) o.hasOwnProperty(n) && delete i[n];t.style.cssText = g.join(i);
      ...
      if (null !== i && "object" === (void 0 === i ? "undefined" : (0, p.default)(i))) {
        for (var o = (0, h.default)(i), n = 0; n < t.length; n++) i.hasOwnProperty(t[n]) && "object" == (0, p.default)(i[t[n]]) && (o[t[n]] = e.bridgeObject(i[t[n]]));return o;
      }return null;
      ...
      if (null !== t && "object" === (void 0 === t ? "undefined" : (0, p.default)(t))) {
        var i = (0, h.default)(t);if (t instanceof Element) i = t;else {
          i = (0, h.default)(t);for (var o in t) t.hasOwnProperty(o) && "object" == (0, p.default)(t[o]) && (i[o] = e.bridgeObject(t[o]));
        }return i;
      }return null;
    }, e.insertSort = function (t, e) {
      for (var i = 0; i < t.length; i++) {
        for (var o = t[i], n = i; n > 0 && e(o, t[n - 1]) < 0; n--) t[n] = t[n - 1];t[n] = o;
      }return t;
      ...
      var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
        ...
        if ("boolean" == typeof r) return s(t[i]) || (t[i] = {}), void (t[i].enabled = r);if (null === r && !s(t[i])) {
          ...
          var u = !0;void 0 !== r.enabled ? u = r.enabled : void 0 !== l && (u = d.enabled), function (t, e, i) {
            s(t[i]) || (t[i] = {});var o = e[i],
                n = t[i];for (var r in o) o.hasOwnProperty(r) && (n[r] = o[r]);
          }(t, e, i), t[i].enabled = u;
        }
      }
      ...
      var i = void 0;Array.isArray(e) || (e = [e]);var o = !0,
        ...
        for (var a, h = (0, r.default)(t); !(o = (a = h.next()).done); o = !0) {
          var d = a.value;if (d) {
            i = d[e[0]];for (var l = 1; l < e.length; l++) i && (i = i[e[l]]);if (void 0 !== i) break;
          }
        }
      } catch (t) {
        n = !0, s = t;
    ...
    e.prepareElements = function (t) {
      ...
      for (var e in t) if (t.hasOwnProperty(e) && t[e].redundant) {
        for (var i = 0; i < t[e].redundant.length; i++) t[e].redundant[i].parentNode.removeChild(t[e].redundant[i]);t[e].redundant = [];
      }
    ...
    function o(t) {
      ...
      var i,
          o = [],
          n = this;if (Array.isArray(t)) for (var s = 0, r = t.length; s < r; s++) i = n._addItem(t[s]), o.push(i);else {
      ...
      };if (Array.isArray(t)) for (var l = 0, p = t.length; l < p; l++) t[l] && "object" === (0, h.default)(t[l]) ? d(t[l]) : console.warn("Ignoring input item, which is not an object at index " + l);else {
      ...
      var e,
        ...
        r = -1 == ["Array", "Object"].indexOf(o.returnType) ? "Array" : o.returnType;
          ...
          f = o && o.filter,
          g = [];if (void 0 != e) (a = n._getItem(e, m)) && f && !f(a) && (a = null);else if (void 0 != i) for (p = 0, c = i.length; p < c; p++) a = n._getItem(i[p], m), f && !f(a) || g.push(a);else for (h = (0, l.default)(this._data), p = 0, c = h.length; p < c; p++) d = h[p], a = n._getItem(d, m), f && !f(a) || g.push(a);if (o && o.order && void 0 == e && this._sort(g, o.order), o && o.fields) {
        var v = o.fields;if (void 0 != e) a = this._filterFields(a, v);else for (p = 0, c = g.length; p < c; p++) g[p] = this._filterFields(g[p], v);
      }if ("Object" == r) {
        var y,
            b = {};for (p = 0, c = g.length; p < c; p++) y = g[p], b[y.id] = y;return b;
      }return void 0 != e ? a : g;
      ...
      var e,
          ...
          p = [];if (a) {
        if (h) {
          for (s = [], e = 0, i = u.length; e < i; e++) o = u[e], n = this._getItem(o, d), a(n) && s.push(n);for (this._sort(s, h), e = 0, i = s.length; e < i; e++) p.push(s[e][this._fieldId]);
        } else for (e = 0, i = u.length; e < i; e++) o = u[e], n = this._getItem(o, d), a(n) && p.push(n[this._fieldId]);
      } else if (h) {
        for (s = [], e = 0, i = u.length; e < i; e++) o = u[e], s.push(r[o]);for (this._sort(s, h), e = 0, i = s.length; e < i; e++) p.push(s[e][this._fieldId]);
      } else for (e = 0, i = u.length; e < i; e++) o = u[e], n = r[o], p.push(n[this._fieldId]);return p;
      ...
      var i,
        ...
        var u = this.get(e);for (i = 0, o = u.length; i < o; i++) n = u[i], s = n[this._fieldId], t(n, s);
      ...
      var i,
          ...
          h = [],
          d = this._data,
          u = (0, l.default)(d);for (i = 0, o = u.length; i < o; i++) n = u[i], s = this._getItem(n, a), r && !r(s) || h.push(t(s, n));return e && e.order && this._sort(h, e.order), h;
    }, n.prototype._filterFields = function (t, e) {
      if (!t) return t;var i,
          o,
          n = {},
          s = (0, l.default)(t),
          r = s.length;if (Array.isArray(e)) for (i = 0; i < r; i++) o = s[i], -1 != e.indexOf(o) && (n[o] = t[o]);else for (i = 0; i < r; i++) o = s[i], e.hasOwnProperty(o) && (n[e[o]] = t[o]);return n;
      ...
      var i,
          ...
          r = [],
          a = [],
          h = [];for (h = Array.isArray(t) ? t : [t], i = 0, o = h.length; i < o; i++) (s = this._remove(h[i])) && void 0 != (n = s[this._fieldId]) && (r.push(n), a.push(s));return r.length && this._trigger("remove", { items: r, oldData: a }, e), r;
      ...
      var e,
        ...
        var d = s[e],
            p = n[d],
            c = p[t],
            m = !1;for (i = 0; i < h; i++) if (r[i] == c) {
          m = !0;break;
        }m || void 0 === c || (r[h] = c, h++);
      }if (a) for (e = 0, o = r.length; e < o; e++) r[e] = u.convert(r[e], a);return r;
      ...
      var i,
          ...
          h = (0, l.default)(r);if (e) for (n = 0, s = h.length; n < s; n++) i = h[n], o = r[i], a[i] = u.convert(o, e[i]);else for (n = 0, s = h.length; n < s; n++) i = h[n], o = r[i], a[i] = o;return a[this._fieldId] || (a[this._fieldId] = r.id), a;
    ...
    var o = i(6),
      ...
      var h,
          ...
          v = p ? n : n[e] || (n[e] = {}),
          y = v.prototype,
          b = p ? o : c ? o[e] : (o[e] || {}).prototype;p && (i = e);for (h in i) (d = !u && b && void 0 !== b[h]) && h in v || (l = d ? b[h] : i[h], v[h] = p && "function" != typeof b[h] ? i[h] : f && d ? s(l, o) : g && b[h] == l ? function (t) {
        var e = function (e, i, o) {
          if (this instanceof t) {
            switch (arguments.length) {case 0:
                return new t();case 1:
                return new t(e);case 2:
                return new t(e, i);}return new t(e, i, o);
    ...
    function o(t, e) {
      ...
      var e, i, o, n, s;if (this._data) {
        for (this._data.off && this._data.off("*", this.listener), e = this._data.getIds({ filter: this._options && this._options.filter }), s = [], o = 0, n = e.length; o < n; o++) s.push(this._data._data[e[o]]);this._ids = {}, this.length = 0, this._trigger("remove", { items: e, oldData: s });
      }if (this._data = t, this._data) {
        for (this._fieldId = this._options.fieldId || this._data && this._data.options && this._data.options.fieldId || "id", e = this._data.getIds({ filter: this._options && this._options.filter }), o = 0, n = e.length; o < n; o++) i = e[o], this._ids[i] = !0;this.length = e.length, this._trigger("add", { items: e }), this._data.on && this._data.on("*", this.listener);
      }
      ...
      var t,
          ...
          a = [],
          h = [],
          d = [];for (e = 0, i = o.length; e < i; e++) t = o[e], r[t] = !0, this._ids[t] || (a.push(t), this._ids[t] = !0);for (e = 0, i = n.length; e < i; e++) t = n[e], r[t] || (h.push(t), d.push(this._data._data[t]), delete this._ids[t]);this.length += a.length - h.length, a.length && this._trigger("add", { items: a }), h.length && this._trigger("remove", { items: h, oldData: d });
      ...
      for (var t = this; t instanceof o;) t = t._data;return t || null;
      ...
      var o,
          ...
          c = [];if (a && this._data) {
        switch (t) {case "add":
            for (o = 0, n = a.length; o < n; o++) s = a[o], (r = this.get(s)) && (this._ids[s] = !0, h.push(s));break;case "update":
            for (o = 0, n = a.length; o < n; o++) s = a[o], r = this.get(s), r ? this._ids[s] ? (d.push(s), p.push(e.data[o]), u.push(e.oldData[o])) : (this._ids[s] = !0, h.push(s)) : this._ids[s] && (delete this._ids[s], l.push(s), c.push(e.oldData[o]));break;case "remove":
            for (o = 0, n = a.length; o < n; o++) s = a[o], this._ids[s] && (delete this._ids[s], l.push(s), c.push(e.oldData[o]));}this.length += h.length - l.length, h.length && this._trigger("add", { items: h }, i), d.length && this._trigger("update", { items: d, oldData: u, data: p }, i), l.length && this._trigger("remove", { items: l, oldData: c }, i);
      }
    ...
    e.convertHiddenOptions = function (t, i, o) {
      ...
      if (o && !Array.isArray(o)) return e.updateHiddenDates(t, i, [o]);if (o && void 0 !== i.domProps.centerContainer.width) {
        e.convertHiddenOptions(t, i, o);for (var n = t(i.range.start), s = t(i.range.end), r = i.range.end - i.range.start, a = r / i.domProps.centerContainer.width, h = 0; h < o.length; h++) if (void 0 !== o[h].repeat) {
          var d = t(o[h].start),
            ...
            var p = 0,
                ...
                return void console.log("Wrong repeat format, allowed are: daily, weekly, monthly, yearly. Given:", o[h].repeat);}for (; d < c;) switch (i.hiddenDates.push({ start: d.valueOf(), end: l.valueOf() }), o[h].repeat) {case "daily":
                ...
                return void console.log("Wrong repeat format, allowed are: daily, weekly, monthly, yearly. Given:", o[h].repeat);}i.hiddenDates.push({ start: d.valueOf(), end: l.valueOf() });
          }
      ...
      for (var e = t.hiddenDates, i = [], o = 0; o < e.length; o++) for (var n = 0; n < e.length; n++) o != n && 1 != e[n].remove && 1 != e[o].remove && (e[n].start >= e[o].start && e[n].end <= e[o].end ? e[n].remove = !0 : e[n].start >= e[o].start && e[n].start <= e[o].end ? (e[o].end = e[n].end, e[n].remove = !0) : e[n].end >= e[o].start && e[n].end <= e[o].end && (e[o].start = e[n].start, e[n].remove = !0));for (o = 0; o < e.length; o++) !0 !== e[o].remove && i.push(e[o]);t.hiddenDates = i, t.hiddenDates.sort(function (t, e) {
        return t.start - e.start;
      });
    ...
    function o(t) {
      ...
      function t() {
        (0, u.default)(this, t);
      }return (0, c.default)(t, null, [{ key: "validate", value: function (e, i, o) {
          ...
          if (0 === t.length) return e.length;if (0 === e.length) return t.length;var i,
              o = [];for (i = 0; i <= e.length; i++) o[i] = [i];var n;for (n = 0; n <= t.length; n++) o[0][n] = n;for (i = 1; i <= e.length; i++) for (n = 1; n <= t.length; n++) e.charAt(i - 1) == t.charAt(n - 1) ? o[i][n] = o[i - 1][n - 1] : o[i][n] = Math.min(o[i - 1][n - 1] + 1, Math.min(o[i][n - 1] + 1, o[i - 1][n] + 1));return o[e.length][t.length];
        } }]), t;
    ...
    var o = i(18),
      ...
      var t,
          e = i(58)("iframe"),
          o = s.length;for (e.style.display = "none", i(99).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object<\/script>"), t.close(), h = t.F; o--;) delete h.prototype[s[o]];return h();
    };t.exports = Object.create || function (t, e) {
      var i;return null !== t ? (a.prototype = o(t), i = new a(), a.prototype = null, i[r] = t) : i = h(), void 0 === e ? i : n(i, e);
    };
  }, function (t, e) {
    var i = Math.ceil,
    ...
    function o(t, e, i) {
      ...
      var e, i;if (this.itemSet.options && this.itemSet.options.groupTemplate ? (i = this.itemSet.options.groupTemplate.bind(this), e = i(t, this.dom.inner)) : e = t && t.content, e instanceof Element) {
        for (this.dom.inner.appendChild(e); this.dom.inner.firstChild;) this.dom.inner.removeChild(this.dom.inner.firstChild);this.dom.inner.appendChild(e);
      ...
      if (t || this.stackDirty || this.isVisible && !e) {
        var n = {},
          ...
          if (this.doInnerStack && this.itemSet.options.stackSubgroups) {
            for (s in this.subgroups) n[s] = this.subgroups[s].items;a.stackSubgroupsWithInnerStack(n, i, this.subgroups);
      ...
      if (void 0 !== this.subgroupOrderer) {
        var t,
          ...
          for (t in this.subgroups) e.push({ subgroup: t, sortField: this.subgroups[t].items[0].data[this.subgroupOrderer] });e.sort(function (t, e) {
            return t.sortField - e.sortField;
          });
        } else if ("function" == typeof this.subgroupOrderer) {
          for (t in this.subgroups) e.push(this.subgroups[t].items[0].data);e.sort(this.subgroupOrderer);
      ...
      for (var t = r.toArray(this.items), e = [], i = [], o = 0; o < t.length; o++) void 0 !== t[o].data.end && i.push(t[o]), e.push(t[o]);this.orderedItems = { byStart: e, byEnd: i }, a.orderByStart(this.orderedItems.byStart), a.orderByEnd(this.orderedItems.byEnd);
      ...
      };if (e.length > 0) for (var l = 0; l < e.length; l++) this._checkIfVisibleWithReference(e[l], o, n, i);var u = r.binarySearchCustom(t.byStart, d, "data", "start");if (this._traceVisible(u, t.byStart, o, n, function (t) {
      ...
      }if (m > 0) for (var g = 0; g < m; g++) r.forEach(c, function (t) {
        t[g]();
      });for (l = 0; l < o.length; l++) o[l].repositionX();return o;
    }, o.prototype._traceVisible = function (t, e, i, o, n) {
      if (-1 != t) {
        var s, r;for (s = t; s >= 0 && (r = e[s], !n(r)); s--) void 0 === o[r.id] && (o[r.id] = !0, i.push(r));for (s = t + 1; s < e.length && (r = e[s], !n(r)); s++) void 0 === o[r.id] && (o[r.id] = !0, i.push(r));
      }
    ...
    function o(t, e) {}function n(t, e) {
      ...
      o = o || 0;for (var r = s(i, e), d = 0; d < t.length; d++) if (r) {
    ...
    var o = i(35),
      ...
      d(i, e, f);var b,
        ...
        if (!c && t in C) return C[t];switch (t) {case "keys":case "values":
          ...
          E = "Array" == e ? C.entries || T : T;if (E && (w = u(E.call(new t()))) !== Object.prototype && w.next && (l(w, D, !0), o || a(w, p) || r(w, p, m)), S && T && "values" !== T.name && (k = !0, M = function () {
        return T.call(this);
      }), o && !y || !c && !k && C[p] || r(C, p, M), h[e] = M, h[D] = m, g) if (b = { values: S ? M : x("values"), keys: v ? M : x("keys"), entries: O }, y) for (_ in b) _ in C || s(C, _, b[_]);else n(n.P + n.F * (c || k), e, b);return b;
    };
  }, function (t, e, i) {
    t.exports = !i(9) && !i(19)(function () {
      return 7 != Object.defineProperty(i(58)("div"), "a", { get: function () {
          return 7;
        } }).a;
    });
  }, function (t, e, i) {
    ...
    var o = i(10),
      ...
      var i,
          a = n(t),
          h = 0,
          d = [];for (i in a) i != r && o(a, i) && d.push(i);for (; e.length > h;) o(a, i = e[h++]) && (~s(d, i) || d.push(i));return d;
    };
  }, function (t, e, i) {
    ...
    function o(t) {
      ...
      var i = this,
        ...
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];i.queue({ args: t, fn: o, context: this });
      };
    ...
    function i(t) {
      ...
      if (this._callbacks = this._callbacks || {}, 0 == arguments.length) return this._callbacks = {}, this;var i = this._callbacks[t];if (!i) return this;if (1 == arguments.length) return delete this._callbacks[t], this;for (var o, n = 0; n < i.length; n++) if ((o = i[n]) === e || o.fn === e) {
        i.splice(n, 1);break;
      }return this;
    }, i.prototype.emit = function (t) {
      this._callbacks = this._callbacks || {};var e = [].slice.call(arguments, 1),
          i = this._callbacks[t];if (i) {
        i = i.slice(0);for (var o = 0, n = i.length; o < n; ++o) i[o].apply(this, e);
      }return this;
    ...
    var o, n, s;!function (i, r) {
      ...
      function t(t) {
        var e,
            ...
            n = {},
            s = { keydown: {}, keyup: {} },
            r = {};for (e = 97; e <= 122; e++) r[String.fromCharCode(e)] = { code: e - 97 + 65, shift: !1 };for (e = 65; e <= 90; e++) r[String.fromCharCode(e)] = { code: e, shift: !0 };for (e = 0; e <= 9; e++) r["" + e] = { code: 48 + e, shift: !1 };for (e = 1; e <= 12; e++) r["F" + e] = { code: 111 + e, shift: !1 };for (e = 0; e <= 9; e++) r["num" + e] = { code: 96 + e, shift: !1 };r["num*"] = { code: 106, shift: !1 }, r["num+"] = { code: 107, shift: !1 }, r["num-"] = { code: 109, shift: !1 }, r["num/"] = { code: 111, shift: !1 }, r["num."] = { code: 110, shift: !1 }, r.left = { code: 37, shift: !1 }, r.up = { code: 38, shift: !1 }, r.right = { code: 39, shift: !1 }, r.down = { code: 40, shift: !1 }, r.space = { code: 32, shift: !1 }, r.enter = { code: 13, shift: !1 }, r.shift = { code: 16, shift: void 0 }, r.esc = { code: 27, shift: !1 }, r.backspace = { code: 8, shift: !1 }, r.tab = { code: 9, shift: !1 }, r.ctrl = { code: 17, shift: !1 }, r.alt = { code: 18, shift: !1 }, r.delete = { code: 46, shift: !1 }, r.pageup = { code: 33, shift: !1 }, r.pagedown = { code: 34, shift: !1 }, r["="] = { code: 187, shift: !1 }, r["-"] = { code: 189, shift: !1 }, r["]"] = { code: 221, shift: !1 }, r["["] = { code: 219, shift: !1 };var a = function (t) {
          d(t, "keydown");
        },
            h = function (t) {
          d(t, "keyup");
          ...
          if (void 0 !== s[e][t.keyCode]) {
            for (var o = s[e][t.keyCode], n = 0; n < o.length; n++) void 0 === o[n].shift ? o[n].fn(t) : 1 == o[n].shift && 1 == t.shiftKey ? o[n].fn(t) : 0 == o[n].shift && 0 == t.shiftKey && o[n].fn(t);1 == i && t.preventDefault();
          }
          ...
          void 0 === e && (e = "keydown");for (var i in r) r.hasOwnProperty(i) && n.bind(i, t, e);
        }, n.getKey = function (t) {
          ...
          if (void 0 === i && (i = "keydown"), void 0 === r[t]) throw new Error("unsupported key: " + t);if (void 0 !== e) {
            var o = [],
                n = s[i][r[t].code];if (void 0 !== n) for (var a = 0; a < n.length; a++) n[a].fn == e && n[a].shift == r[t].shift || o.push(s[i][r[t].code][a]);s[i][r[t].code] = o;
          } else s[i][r[t].code] = [];
        }, n.reset = function () {
          s = { keydown: {}, keyup: {} };
        }, n.destroy = function () {
    ...
    function o(t) {
      ...
      this.body = t, this.defaultOptions = { type: null, orientation: { item: "bottom" }, align: "auto", stack: !0, stackSubgroups: !0, groupOrderSwap: function (t, e, i) {
          var o = e.order;e.order = t.order, t.order = o;
        }, groupOrder: "order", selectable: !0, multiselect: !1, itemsAlwaysDraggable: { item: !1, range: !1 }, editable: { updateTime: !1, updateGroup: !1, add: !1, remove: !1, overrideItems: !1 }, groupEditable: { order: !1, add: !1, remove: !1 }, snap: c.snap, onDropObjectOnItem: function (t, e, i) {
          i(e);
        }, onAdd: function (t, e) {
          e(t);
      ...
      var e, i, o, n;for (void 0 == t && (t = []), Array.isArray(t) || (t = [t]), e = 0, i = this.selection.length; e < i; e++) o = this.selection[e], (n = this.items[o]) && n.unselect();for (this.selection = [], e = 0, i = t.length; e < i; e++) o = t[e], (n = this.items[o]) && (this.selection.push(o), n.select());
    }, n.prototype.getSelection = function () {
      return this.selection.concat([]);
    }, n.prototype.getVisibleItems = function () {
      var t,
          e,
          i = this.body.range.getRange();this.options.rtl ? (t = this.body.util.toScreen(i.start), e = this.body.util.toScreen(i.end)) : (e = this.body.util.toScreen(i.start), t = this.body.util.toScreen(i.end));var o = [];for (var n in this.groups) if (this.groups.hasOwnProperty(n)) for (var s = this.groups[n], r = s.isVisible ? s.visibleItems : [], a = 0; a < r.length; a++) {
      ...
      var t,
        ...
        if (i) {
          i.hide(), delete this.groups[x];for (e in this.items) if (this.items.hasOwnProperty(e)) {
            t = this.items[e], t.parent && t.parent.remove(t);var o = this._getGroupId(t.data),
                n = this.groups[o];n && n.add(t) || t.hide();
          }
        }
      } else if (!i) {
        i = new f(null, null, this), this.groups[x] = i;for (e in this.items) this.items.hasOwnProperty(e) && (t = this.items[e], i.add(t));i.show();
      }
      ...
      var e = this;t.forEach(function (t) {
        var i = e.groupsData.get(t),
          ...
          if (t == x || t == D) throw new Error("Illegal group id. " + t + " is a reserved id.");var n = (0, r.default)(e.options);l.extend(n, { height: null }), o = new f(t, i, e), e.groups[t] = o;for (var s in e.items) if (e.items.hasOwnProperty(s)) {
      ...
      var e = [];return t.forEach(function (t) {
        var i = this.groupsData.get(t);if (i.nestedInGroup || e.push(t), i.nestedGroups) {
          var o = this.groupsData.get({ filter: function (e) {
      ...
      for (var e = [], i = 0; i < t.length; i++) t[i] instanceof b && e.push(t[i]);return e;
    }, n.prototype._onTouch = function (t) {
      ...
      if (this.options.groupEditable.order && this.groupTouchParams.group) {
        t.stopPropagation();var e = this.groupsData;this.groupsData instanceof p && (e = this.groupsData.getDataSet());var i = this.groupFromTarget(t);if (i && i.height != this.groupTouchParams.group.height) {
          ...
          var a = e.get(i.groupId),
            ...
            for (; f + g < m && f + v < m && d[f + g] == u[f + v];) f++;if (f + g >= m) break;if (d[f + g] == c) g = 1;else if (u[f + v] == c) v = 1;else {
        ...
        t.stopPropagation();var e = this,
          ...
          if (t) t[o._fieldId] = i, o.update(t);else {
            var n = o.getIds({ order: e.options.groupOrder });if (!l.equalArray(n, e.groupTouchParams.originalOrder)) for (var s = e.groupTouchParams.originalOrder, r = Math.min(s.length, n.length), a = 0; a < r;) {
              for (; a < r && n[a] == s[a];) a++;if (a >= r) break;var h = n.indexOf(s[a]),
                  d = o.get(n[a]),
        ...
        var e = this.itemFromTarget(t);if (e) {
          var i = this.options.multiselect ? this.getSelection() : [];if ((t.srcEvent && t.srcEvent.shiftKey || !1) && this.options.multiselect) {
            var o = this.itemsData.get(e.id).group,
              ...
              i = [];for (var a in this.items) if (this.items.hasOwnProperty(a)) {
                var h = this.items[a],
                    d = h.data.start,
    ...
    e.orderByStart = function (t) {
      ...
      if (o) for (var n = 0; n < t.length; n++) t[n].top = null;for (var n = 0; n < t.length; n++) {
      ...
      for (var n = 0; n < t.length; n++) t[n].top = null;var s = o.height;for (n = 0; n < t.length; n++) {
      ...
      for (var s = 0; s < t.length; s++) if (void 0 == t[s].data.subgroup) t[s].top = i.item.vertical;else if (void 0 !== t[s].data.subgroup && n) {
        var r = 0;for (var a in o) o.hasOwnProperty(a) && 1 == o[a].visible && o[a].index < o[t[s].data.subgroup].index && (r += o[a].height, o[t[s].data.subgroup].top = r);t[s].top = r + .5 * i.item.vertical;
      }n || e.stackSubgroups(t, i, o);
    }, e.stackSubgroups = function (t, i, o) {
      for (var n in o) if (o.hasOwnProperty(n)) {
        o[n].top = 0;do {
          var s = null;for (var r in o) if (null !== o[r].top && r !== n && o[n].index > o[r].index && e.collisionByTimes(o[n], o[r])) {
            s = o[r];break;
      ...
      var n = !1,
          s = [];for (var r in o) o[r].hasOwnProperty("index") ? s[o[r].index] = r : s.push(r);for (var a = 0; a < s.length; a++) if (r = s[a], o.hasOwnProperty(r)) {
        n = n || o[r].stack, o[r].top = 0;for (var h in o) o[h].visible && o[r].index > o[h].index && (o[r].top += o[h].height);for (var d = t[r], l = 0; l < d.length; l++) void 0 !== d[l].data.subgroup && (d[l].top = o[d[l].data.subgroup].top + .5 * i.item.vertical, o[r].stack && (d[l].baseTop = d[l].top));n && o[r].stack && e.substack(t[r], i, o[r]);
      }
    ...
    function o(t) {
      ...
      function t(e, i, o) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1;(0, d.default)(this, t), this.parent = e, this.changedOptions = [], this.container = i, this.allowCreation = !1, this.options = {}, this.initialized = !1, this.popupCounter = 0, this.defaultOptions = { enabled: !1, filter: !0, container: void 0, showButton: !0 }, p.extend(this.options, this.defaultOptions), this.configureOptions = o, this.moduleOptions = {}, this.domElements = [], this.popupDiv = {}, this.popupLimit = 5, this.popupHistory = {}, this.colorPicker = new c(n), this.wrapper = void 0;
      }return (0, u.default)(t, [{ key: "setOptions", value: function (t) {
          if (void 0 !== t) {
          ...
          var t = this;this._clean(), this.changedOptions = [];var e = this.options.filter,
              i = 0,
              o = !1;for (var n in this.configureOptions) this.configureOptions.hasOwnProperty(n) && (this.allowCreation = !1, o = !1, "function" == typeof e ? (o = e(n, []), o = o || this._handleObject(this.configureOptions[n], [n], !0)) : !0 !== e && -1 === e.indexOf(n) || (o = !0), !1 !== o && (this.allowCreation = !0, i > 0 && this._makeItem([]), this._makeHeader(n), this._handleObject(this.configureOptions[n], [n])), i++);if (!0 === this.options.showButton) {
          ...
          this.wrapper = document.createElement("div"), this.wrapper.className = "vis-configuration-wrapper", this.container.appendChild(this.wrapper);for (var t = 0; t < this.domElements.length; t++) this.wrapper.appendChild(this.domElements[t]);this._showPopupIfNeeded();
        } }, { key: "_clean", value: function () {
          for (var t = 0; t < this.domElements.length; t++) this.wrapper.removeChild(this.domElements[t]);void 0 !== this.wrapper && (this.container.removeChild(this.wrapper), this.wrapper = void 0), this.domElements = [], this._removePopup();
          ...
          if (!0 === this.allowCreation) {
            var e = document.createElement("div");e.className = "vis-configuration vis-config-item vis-config-s" + t.length;for (var i = arguments.length, o = Array(i > 1 ? i - 1 : 0), n = 1; n < i; n++) o[n - 1] = arguments[n];return o.forEach(function (t) {
              e.appendChild(t);
          ...
          var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
              ...
              s = !1;for (var r in t) if (t.hasOwnProperty(r)) {
            o = !0;var a = t[r],
          ...
          var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
              o = i;t = "true" === t || t, t = "false" !== t && t;for (var n = 0; n < e.length; n++) "global" !== e[n] && (void 0 === o[e[n]] && (o[e[n]] = {}), n !== e.length - 1 ? o = o[e[n]] : o[e[n]] = t);return i;
          ...
          for (var t = {}, e = 0; e < this.changedOptions.length; e++) this._constructOptions(this.changedOptions[e].value, this.changedOptions[e].path, t);return t;
        } }]), t;
    }();e.default = m;
  }, function (t, e, i) {
    function o(t, e) {
      this.id = r.randomUUID(), this.body = t, this.defaultOptions = { yAxisOrientation: "left", defaultGroup: "default", sort: !0, sampling: !0, stack: !1, graphHeight: "400px", shaded: { enabled: !1, orientation: "bottom" }, style: "line", barChart: { width: 50, sideBySide: !1, align: "center" }, interpolation: { enabled: !0, parametrization: "centripetal", alpha: .5 }, drawPoints: { enabled: !0, size: 6, style: "square" }, dataAxis: {}, legend: {}, groups: { visibility: {} } }, this.options = r.extend({}, this.defaultOptions), this.dom = {}, this.props = {}, this.hammer = null, this.groups = {}, this.abortedGraphUpdate = !1, this.updateSVGheight = !1, this.updateSVGheightOnResize = !1, this.forceGraphUpdate = !0;var i = this;this.itemsData = null, this.groupsData = null, this.itemListeners = { add: function (t, e, o) {
          i._onAdd(e.items);
        }, update: function (t, e, o) {
          i._onUpdate(e.items);
        }, remove: function (t, e, o) {
      ...
      var e,
        ...
        r.forEach(this.groupListeners, function (t, e) {
          i.groupsData.off(e, t);
        }), e = this.groupsData.getIds(), this.groupsData = null;for (var o = 0; o < e.length; o++) this._removeGroup(e[o]);
      }if (t) {
      ...
      for (var e = 0; e < t.length; e++) this._removeGroup(t[e]);this.forceGraphUpdate = !0, this.body.emitter.emit("_change", { queue: !0 });
      ...
      if (null != this.itemsData) {
        ...
        }var u = {};if (!e && t) for (l in this.groups) if (this.groups.hasOwnProperty(l)) {
        ...
        }for (l in this.groups) this.groups.hasOwnProperty(l) && (i.hasOwnProperty(l) || (i[l] = new Array(0)));for (l in i) if (i.hasOwnProperty(l)) if (0 == i[l].length) this.groups.hasOwnProperty(l) && this._removeGroup(l);else {
      ...
      var t = [];for (var e in this.groups) if (this.groups.hasOwnProperty(e)) {
      ...
      if (a.prepareElements(this.svgElements), 0 != this.props.width && null != this.itemsData) {
        var t,
          ...
          var r = {};for (this._getRelevantData(s, r, o, n), this._applySampling(s, r), e = 0; e < s.length; e++) this._convertXcoordinates(r[s[e]]);if (this._getYRanges(s, r, i), 1 == this._updateYAxis(s, i)) return a.cleanupElements(this.svgElements), this.abortedGraphUpdate = !0, !0;this.abortedGraphUpdate = !1;var h = void 0;for (e = 0; e < s.length; e++) t = this.groups[s[e]], !0 === this.options.stack && "line" === this.options.style && (void 0 != t.options.excludeFromStacking && t.options.excludeFromStacking || (void 0 != h && (this._stack(r[t.id], r[h.id]), 1 == t.options.shaded.enabled && "group" !== t.options.shaded.orientation && ("top" == t.options.shaded.orientation && "group" !== h.options.shaded.orientation ? (h.options.shaded.orientation = "group", h.options.shaded.groupId = t.id) : (t.options.shaded.orientation = "group", t.options.shaded.groupId = h.id))), h = t)), this._convertYcoordinates(r[s[e]], t);var d = {};for (e = 0; e < s.length; e++) if (t = this.groups[s[e]], "line" === t.options.style && 1 == t.options.shaded.enabled) {
          ...
          }for (m.draw(s, r, this.framework), e = 0; e < s.length; e++) if (t = this.groups[s[e]], r[s[e]].length > 0) switch (t.options.style) {case "line":
        ...
        n = this.groups[t[s]];var d = n.getItems();if (1 == n.options.sort) {
          var l = function (t, e) {
            return t.getTime() == e.getTime() ? 0 : t < e ? -1 : 1;
              ...
              p = Math.min(d.length, r.binarySearchValue(d, o, "x", "after", l) + 1);p <= 0 && (p = d.length);var c = new Array(p - u);for (a = u; a < p; a++) h = n.itemsData[a], c[a - u] = h;e[t[s]] = c;
        } else e[t[s]] = n.itemsData;
      }
    }, o.prototype._applySampling = function (t, e) {
      var i;if (t.length > 0) for (var o = 0; o < t.length; o++) if (i = this.groups[t[o]], 1 == i.options.sampling) {
      ...
      var o,
          ...
          a = [],
          h = [];if (t.length > 0) {
        for (s = 0; s < t.length; s++) o = e[t[s]], r = this.groups[t[s]].options, o.length > 0 && (n = this.groups[t[s]], !0 === r.stack && "bar" === r.style ? "left" === r.yAxisOrientation ? a = a.concat(o) : h = h.concat(o) : i[t[s]] = n.getYRange(o, t[s]));m.getStackedYRange(a, i, t, "__barStackLeft", "left"), m.getStackedYRange(h, i, t, "__barStackRight", "right");
      }
      ...
      var i,
        ...
        }for (u = 0; u < t.length; u++) e.hasOwnProperty(t[u]) && !0 !== e[t[u]].ignore && (i = e[t[u]].min, o = e[t[u]].max, "right" != e[t[u]].yAxisOrientation ? (s = !0, a = a > i ? i : a, d = d < o ? o : d) : (r = !0, h = h > i ? i : h, l = l < o ? o : l));1 == s && this.yAxisLeft.setRange(a, d), 1 == r && this.yAxisRight.setRange(h, l);
      ...
      var i = this.yAxisLeft,
          o = Number(this.svg.style.height.replace("px", ""));"right" == e.options.yAxisOrientation && (i = this.yAxisRight);for (var n = 0; n < t.length; n++) t[n].screen_y = Math.round(i.convertValue(t[n].y));e.setZeroPosition(Math.min(o, i.convertValue(0)));
    }, t.exports = o;
  }, function (t, e, i) {
    function o(t, e, i, o) {
      this.id = r.randomUUID(), this.body = t, this.defaultOptions = { orientation: "left", showMinorLabels: !0, showMajorLabels: !0, icons: !1, majorLinesOffset: 7, minorLinesOffset: 4, labelOffsetX: 10, labelOffsetY: 2, iconWidth: 20, width: "40px", visible: !0, alignZeros: !0, left: { range: { min: void 0, max: void 0 }, format: function (t) {
      ...
      var t = !1,
          e = 0;this.dom.lineContainer.style.top = this.body.domProps.scrollTop + "px";for (var i in this.groups) this.groups.hasOwnProperty(i) && (!0 !== this.groups[i].visible || void 0 !== this.linegraphOptions.visibility[i] && !0 !== this.linegraphOptions.visibility[i] || e++);if (0 === this.amountOfGroups || 0 === e) this.hide();else {
    ...
    function o(t, e, i, o, n, s) {
      ...
      for (var t = [], e = this.getStep(), i = (e - this._start % e) % e, o = this._start + i; this._end - o > 1e-5; o += e) o != this._start && t.push({ major: this.is_major(o), y: this.convertValue(o), val: this.formatValue(o) });return t;
    ...
    function o(t, e, i, o) {
      ...
      for (var e = t[0].y, i = t[0].y, o = 0; o < t.length; o++) e = e > t[o].y ? t[o].y : e, i = i < t[o].y ? t[o].y : i;return { min: e, max: i, yAxisOrientation: this.options.yAxisOrientation };
    }, t.exports = o;
  }, function (t, e, i) {
    function o(t, e) {}var n = i(11),
      ...
      var r,
          ...
          p = [],
          c = {},
          m = 0;for (l = 0; l < t.length; l++) if (d = i.groups[t[l]], "bar" === d.options.style && !0 === d.visible && (void 0 === i.options.groups.visibility[t[l]] || !0 === i.options.groups.visibility[t[l]])) for (u = 0; u < e[t[l]].length; u++) p.push({ screen_x: e[t[l]][u].screen_x, screen_end: e[t[l]][u].screen_end, screen_y: e[t[l]][u].screen_y, x: e[t[l]][u].x, end: e[t[l]][u].end, y: e[t[l]][u].y, groupId: t[l], label: e[t[l]][u].label }), m += 1;if (0 !== m) for (p.sort(function (t, e) {
      ...
      for (var i, o = 0; o < e.length; o++) o + 1 < e.length && (i = Math.abs(e[o + 1].screen_x - e[o].screen_x)), o > 0 && (i = Math.min(i, Math.abs(e[o - 1].screen_x - e[o].screen_x))), 0 === i && (void 0 === t[e[o].screen_x] && (t[e[o].screen_x] = { amount: 0, resolved: 0, accumulatedPositive: 0, accumulatedNegative: 0 }), t[e[o].screen_x].amount += 1);
      ...
      for (var i, o = e[0].screen_y, n = e[0].screen_y, s = 0; s < e.length; s++) i = e[s].screen_x, void 0 === t[i] ? (o = o > e[s].screen_y ? e[s].screen_y : o, n = n < e[s].screen_y ? e[s].screen_y : n) : e[s].screen_y < 0 ? t[i].accumulatedNegative += e[s].screen_y : t[i].accumulatedPositive += e[s].screen_y;for (var r in t) t.hasOwnProperty(r) && (o = o > t[r].accumulatedNegative ? t[r].accumulatedNegative : o, o = o > t[r].accumulatedPositive ? t[r].accumulatedPositive : o, n = n < t[r].accumulatedNegative ? t[r].accumulatedNegative : n, n = n < t[r].accumulatedPositive ? t[r].accumulatedPositive : n);return { min: o, max: n };
    }, t.exports = o;
  }, function (t, e, i) {
    function o(t, e) {}var n = i(11);o.calcPath = function (t, e) {
      ...
      if (t.length < 2) return "";var o,
          n = e;if (i) for (o = t.length - 2; o > 0; o--) n += t[o][0] + "," + t[o][1] + " ";else for (o = 1; o < t.length; o++) n += t[o][0] + "," + t[o][1] + " ";return n;
    ...
    var o = i(8),
      ...
      n(t);for (var i, r = s(e), a = r.length, h = 0; a > h;) o.f(t, i = r[h++], e[i]);return t;
    };
  }, function (t, e, i) {
    var o = i(13),
        n = i(97),
      ...
      return function (e, i, r) {
        ...
        } else for (; d > l; l++) if ((t || l in h) && h[l] === i) return t || l || 0;return !t && -1;
      };
    };
  }, function (t, e, i) {
    var o = i(38),
    ...
    var o = i(6),
      ...
      var o = T(j, e);o && delete j[e], M(t, e, i), o && t !== j && M(j, e, o);
        ...
        V = function (t) {
      var e = F[t] = x(E.prototype);return e._k = t, e;
    },
      ...
      return t === j && U(H, e, i), y(t), e = _(e, !0), y(i), n(F, e) ? (i.enumerable ? (n(t, N) && t[N][e] && (t[N][e] = !1), i = x(i, { enumerable: w(0, !1) })) : (n(t, N) || M(t, N, w(1, {})), t[N][e] = !0), W(t, e, i)) : M(t, e, i);
        ...
        q = function (t, e) {
      y(t);for (var i, o = g(e = b(e)), n = 0, s = o.length; s > n;) U(t, i = o[n++], e[i]);return t;
    },
        X = function (t, e) {
      ...
      if (t = b(t), e = _(e, !0), t !== j || !n(F, e) || n(H, e)) {
        ...
        J = function (t) {
      for (var e, i = O(b(t)), o = [], s = 0; i.length > s;) n(F, e = i[s++]) || e == N || e == h || o.push(e);return o;
    },
        $ = function (t) {
      for (var e, i = t === j, o = O(i ? H : b(t)), s = [], r = 0; o.length > r;) !n(F, e = o[r++]) || i && !n(j, e) || s.push(F[e]);return s;
    };Y || (E = function () {
      if (this instanceof E) throw TypeError("Symbol is not a constructor!");var t = p(arguments.length > 0 ? arguments[0] : void 0),
          e = function (i) {
      ...
      return V(c(t));
    }), r(r.G + r.W + r.F * !Y, { Symbol: E });for (var Q = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), tt = 0; Q.length > tt;) c(Q[tt++]);for (var et = C(c.store), it = 0; et.length > it;) f(et[it++]);r(r.S + r.F * !Y, "Symbol", { for: function (t) {
        return n(L, t += "") ? L[t] : L[t] = E(t);
      }, keyFor: function (t) {
        if (!B(t)) throw TypeError(t + " is not a symbol!");for (var e in L) if (L[e] === t) return e;
      }, useSetter: function () {
        z = !0;
      }, useSimple: function () {
        z = !1;
      ...
      var t = E();return "[null]" != I([t]) || "{}" != I({ a: t }) || "{}" != I(Object(t));
    })), "JSON", { stringify: function (t) {
        if (void 0 !== t && !B(t)) {
          for (var e, i, o = [t], n = 1; arguments.length > n;) o.push(arguments[n++]);return e = o[1], "function" == typeof e && (i = e), !i && v(e) || (e = function (t, e) {
    ...
    var o = i(26),
      ...
      var e = o(t),
          i = n.f;if (i) for (var r, a = i(t), h = s.f, d = 0; a.length > d;) h.call(t, r = a[d++]) && e.push(r);return e;
    };
  }, function (t, e, i) {
    ...
    (function (t) {
      !function (e, i) {
        ...
        function e() {
          ...
          for (var i in e) d(e, i) && (t[i] = e[i]);return d(e, "toString") && (t.toString = e.toString), d(e, "valueOf") && (t.valueOf = e.valueOf), t;
        }function u(t, e, i, o) {
            ...
            if (null != e.deprecationHandler && e.deprecationHandler(null, t), o) {
              for (var n, s = [], r = 0; r < arguments.length; r++) {
                if (n = "", "object" == typeof arguments[r]) {
                  n += "\n[" + r + "] ";for (var a in arguments[0]) n += a + ": " + arguments[0][a] + ", ";n = n.slice(0, -2);
          ...
          var e, i;for (i in t) e = t[i], k(e) ? this[i] = e : this["_" + i] = e;this._config = t, this._dayOfMonthOrdinalParseLenient = new RegExp((this._dayOfMonthOrdinalParse.source || this._ordinalParse.source) + "|" + /\d{1,2}/.source);
        }function T(t, e) {
          var i,
              n = l({}, t);for (i in e) d(e, i) && (o(t[i]) && o(e[i]) ? (n[i] = {}, l(n[i], t[i]), l(n[i], e[i])) : null != e[i] ? n[i] = e[i] : delete n[i]);for (i in t) d(t, i) && !d(e, i) && o(t[i]) && (n[i] = l({}, n[i]));return n;
        }function M(t) {
          null != t && this.set(t);
        }function O(t, e, i) {
          ...
          var e,
              i,
              o = {};for (i in t) d(t, i) && (e = L(i)) && (o[e] = t[i]);return o;
        }function H(t, e) {
          Ho[t] = e;
        }function j(t) {
          var e = [];for (var i in t) e.push({ unit: i, priority: Ho[i] });return e.sort(function (t, e) {
          ...
          var e,
              i,
              o = t.match(jo);for (e = 0, i = o.length; e < i; e++) zo[o[e]] ? o[e] = zo[o[e]] : o[e] = z(o[e]);return function (e) {
            var n,
                s = "";for (n = 0; n < i; n++) s += k(o[n]) ? o[n].call(e, t) : o[n];return s;
          };
        }function V(t, e) {
          ...
          }var o = 5;for (Yo.lastIndex = 0; o >= 0 && Yo.test(t);) t = t.replace(Yo, i), Yo.lastIndex = 0, o -= 1;return t;
        }function U(t, e, i) {
          ...
          var i,
              o = e;for ("string" == typeof t && (t = [t]), r(e) && (o = function (t, i) {
            i[e] = _(t);
          ...
          if ("object" == typeof t) {
            t = F(t);for (var i = j(t), o = 0; o < i.length; o++) this[i[o].unit](t[i[o].unit]);
          ...
          var e,
            ...
            for (c(t).iso = !0, e = 0, i = Gn.length; e < i; e++) if (Gn[e][1].exec(h[1])) {
              n = Gn[e][0], o = !1 !== Gn[e][2];break;
            }if (null == n) return void (t._isValid = !1);if (h[3]) {
              for (e = 0, i = zn.length; e < i; e++) if (zn[e][1].exec(h[3])) {
                s = (h[2] || " ") + zn[e][0];break;
          ...
          if (t._f === e.ISO_8601) return void de(t);if (t._f === e.RFC_2822) return void fe(t);t._a = [], c(t).empty = !0;var i,
              ...
              a = "" + t._i,
              h = a.length,
              d = 0;for (n = B(t._f, t._locale).match(jo) || [], i = 0; i < n.length; i++) s = n[i], o = (a.match(q(s, t)) || [])[0], o && (r = a.substr(0, a.indexOf(o)), r.length > 0 && c(t).unusedInput.push(r), a = a.slice(a.indexOf(o) + o.length), d += o.length), zo[s] ? (o ? c(t).empty = !1 : c(t).unusedTokens.push(s), $(s, o, t)) : t._strict && !o && c(t).unusedTokens.push(s);c(t).charsLeftOver = h - d, a.length > 0 && c(t).unusedInput.push(a), t._a[pn] <= 12 && !0 === c(t).bigHour && t._a[pn] > 0 && (c(t).bigHour = void 0), c(t).parsedDateParts = t._a.slice(0), c(t).meridiem = t._meridiem, t._a[pn] = ye(t._locale, t._a[pn], t._meridiem), ae(t), ne(t);
        }function ye(t, e, i) {
          var o;return null == i ? e : null != t.meridiemHour ? t.meridiemHour(e, i) : null != t.isPM ? (o = t.isPM(i), o && e < 12 && (e += 12), o || 12 !== e || (e = 0), e) : e;
        }function be(t) {
          var e, i, o, n, s;if (0 === t._f.length) return c(t).invalidFormat = !0, void (t._d = new Date(NaN));for (n = 0; n < t._f.length; n++) s = 0, e = g({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[n], ve(e), m(e) && (s += c(e).charsLeftOver, s += 10 * c(e).unusedTokens.length, c(e).score = s, (null == o || s < o) && (o = s, i = e));l(t, i || e);
        }function _e(t) {
          if (!t._d) {
          ...
          var o, n;if (1 === e.length && i(e[0]) && (e = e[0]), !e.length) return ke();for (o = e[0], n = 1; n < e.length; ++n) e[n].isValid() && !e[n][t](o) || (o = e[n]);return o;
        }function Te() {
          return Ce("isBefore", [].slice.call(arguments, 0));
        }function Me() {
          return Ce("isAfter", [].slice.call(arguments, 0));
        }function Oe(t) {
          for (var e in t) if (-1 === yn.call(Zn, e) || null != t[e] && isNaN(t[e])) return !1;for (var i = !1, o = 0; o < Zn.length; ++o) if (t[Zn[o]]) {
          ...
          if (r(t) && (e = t, t = void 0), t = t || "", null != e) return Ki(t, e, i, "month");var o,
              n = [];for (o = 0; o < 12; o++) n[o] = Ki(t, o, i, "month");return n;
        }function $i(t, e, i, o) {
          "boolean" == typeof t ? (r(e) && (i = e, e = void 0), e = e || "") : (e = t, i = e, t = !1, r(e) && (i = e, e = void 0), e = e || "");var n = ie(),
              ...
              h = [];for (a = 0; a < 7; a++) h[a] = Ki(e, (a + s) % 7, o, "day");return h;
        }function Qi(t, e) {
          ...
          for (var e = Object(this), i = e.length >>> 0, o = 0; o < i; o++) if (o in e && t.call(this, e[o], o, e)) return !0;return !1;
          ...
          var e,
              i = [];for (e in t) d(t, e) && i.push(e);return i;
    ...
    function o(t, e, i, n) {
      if (!(this instanceof o)) throw new SyntaxError("Constructor must be called with the new operator");if (!(Array.isArray(i) || i instanceof d || i instanceof l) && i instanceof Object) {
        ...
        this.dom.root.style.visibility = "hidden";for (var p, f = this.dom.root; !p && f;) p = window.getComputedStyle(f, null).direction, f = f.parentElement;this.options.rtl = p && "rtl" == p.toLowerCase();
      } else this.options.rtl = n.rtl;this.options.rollingMode = n && n.rollingMode, this.options.onInitialDrawComplete = n && n.onInitialDrawComplete, this.components = [], this.body = { dom: this.dom, domProps: this.props, emitter: { on: this.on.bind(this), off: this.off.bind(this), emit: this.emit.bind(this) }, hiddenDates: [], util: { getScale: function () {
      ...
      var t = this.getDataRange(),
        ...
        });if (u > 0) for (var p = 0; p < u; p++) h.forEach(l, function (t) {
          t[p]();
      ...
      var t = null;return function e(i, o) {
        function n(t) {
          ...
          if ("hammer.input" !== e.type) {
            ...
            var s = n.hammer;if (s) for (var r, a = 0; a < s.length; a++) if (r = s[a]._handlers[e.type]) for (var h = 0; h < r.length && !i; h++) r[h](e);n = n.parentNode;
          }
    ...
    !function (n, s, r, a) {
      function h(t, e, i) {
        ...
        var o;if (t) if (t.forEach) t.forEach(e, i);else if (t.length !== a) for (o = 0; o < t.length;) e.call(i, t[o], o, t), o++;else for (o in t) t.hasOwnProperty(o) && e.call(i, t[o], o, t);
      }function u(t, e, i) {
        ...
        for (var e = [], i = 0; i < t.pointers.length;) e[i] = { clientX: yt(t.pointers[i].clientX), clientY: yt(t.pointers[i].clientY) }, i++;return { timeStamp: _t(), pointers: e, center: A(e), deltaX: t.deltaX, deltaY: t.deltaY };
      }function A(t) {
        var e = t.length;if (1 === e) return { x: yt(t[0].clientX), y: yt(t[0].clientY) };for (var i = 0, o = 0, n = 0; n < e;) i += t[n].clientX, o += t[n].clientY, n++;return { x: yt(i / e), y: yt(o / e) };
      }function R(t, e, i) {
        ...
        var i = x(t.touches),
          ...
          return y(t.target, h);
        }), e === Ot) for (n = 0; n < s.length;) o[s[n].identifier] = !0, n++;for (n = 0; n < r.length;) o[r[n].identifier] && a.push(r[n]), e & (Pt | It) && delete o[r[n].identifier], n++;return a.length ? [D(s.concat(a), "identifier", !0), a] : void 0;
      }function q() {
        ...
        if (t === a || null === t) throw new TypeError("Cannot convert undefined or null to object");for (var e = Object(t), i = 1; i < arguments.length; i++) {
          var o = arguments[i];if (o !== a && null !== o) for (var n in o) o.hasOwnProperty(n) && (e[n] = o[n]);
        }return e;
      } : Object.assign;var wt = u(function (t, e, i) {
        for (var o = Object.keys(e), n = 0; n < o.length;) (!i || i && t[o[n]] === a) && (t[o[n]] = e[o[n]]), n++;return t;
      }, "extend", "Use `assign`."),
          xt = u(function (t, e) {
        return wt(t, e, !0);
      }, "merge", "Use `assign`."),
          ...
          Yt = Ht | jt,
          Gt = ["x", "y"],
          zt = ["clientX", "clientY"];T.prototype = { handler: function () {}, init: function () {
          ...
          Vt = "mousedown",
          Bt = "mousemove mouseup";p(G, T, { handler: function (t) {
          ...
          Xt = "pointerdown",
          Zt = "pointermove pointerup pointercancel";n.MSPointerEvent && !n.PointerEvent && (Xt = "MSPointerDown", Zt = "MSPointerMove MSPointerUp MSPointerCancel"), p(z, T, { handler: function (t) {
          var e = this.store,
              i = !1,
          ...
          Jt = "touchstart",
          $t = "touchstart touchmove touchend touchcancel";p(W, T, { handler: function (t) {
        ...
        if (!ne) return !1;var t = {},
          ...
          me = 8,
          fe = me,
          ge = 16;Q.prototype = { defaults: {}, set: function (t) {
        ...
        }, process: function (t) {}, getTouchAction: function () {}, reset: function () {} }, p(ot, Q, { defaults: { pointers: 1 }, attrTest: function (t) {
        ...
        } }), p(nt, ot, { defaults: { event: "pan", threshold: 10, pointers: 1, direction: Yt }, getTouchAction: function () {
        ...
        } }), p(st, ot, { defaults: { event: "pinch", threshold: 0, pointers: 2 }, getTouchAction: function () {
          return [ae];
        }, attrTest: function (t) {
        ...
        } }), p(rt, Q, { defaults: { event: "press", pointers: 1, time: 251, threshold: 9 }, getTouchAction: function () {
          return [se];
        }, process: function (t) {
          var e = this.options,
        ...
        } }), p(at, ot, { defaults: { event: "rotate", threshold: 0, pointers: 2 }, getTouchAction: function () {
          return [ae];
        }, attrTest: function (t) {
          return this._super.attrTest.call(this, t) && (Math.abs(t.rotation) > this.options.threshold || this.state & pe);
        } }), p(ht, ot, { defaults: { event: "swipe", threshold: 10, velocity: .3, direction: Ht | jt, pointers: 1 }, getTouchAction: function () {
        ...
        } }), p(dt, Q, { defaults: { event: "tap", pointers: 1, taps: 1, interval: 300, time: 250, threshold: 9, posThreshold: 10 }, getTouchAction: function () {
          return [re];
        }, process: function (t) {
          var e = this.options,
              i = t.pointers.length === e.pointers,
          ...
          var e = this.session;if (!e.stopped) {
            this.touchAction.preventDefaults(t);var i,
                o = this.recognizers,
                n = e.curRecognizer;(!n || n && n.state & fe) && (n = e.curRecognizer = null);for (var s = 0; s < o.length;) i = o[s], 2 === e.stopped || n && i != n && !i.canRecognizeWith(n) ? i.reset() : i.recognize(t), !n && i.state & (pe | ce | me) && (n = e.curRecognizer = i), s++;
          }
        }, get: function (t) {
          if (t instanceof Q) return t;for (var e = this.recognizers, i = 0; i < e.length; i++) if (e[i].options.event == t) return e[i];return null;
        }, add: function (t) {
    ...
    function o(t) {
      ...
      }return (0, a.default)(t, [{ key: "setPosition", value: function (t, e) {
    ...
    function o(t) {
      ...
      }return (0, d.default)(t, [{ key: "insertTo", value: function (t) {
    ...
    function o(t, e, i, o) {
      ...
      var t = null,
          e = null;for (var i in this.linegraph.groups) if (this.linegraph.groups.hasOwnProperty(i) && 1 == this.linegraph.groups[i].visible) for (var o = 0; o < this.linegraph.groups[i].itemsData.length; o++) {
