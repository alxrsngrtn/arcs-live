/// BareSpecifier=@polymer/iron-location/test/initialization-cases
/**
@license
...
Polymer({
  is: 'on-attached',
  properties: { val: { type: String, notify: true, value: 'on-attached-default-value' } },
  attached: function () {
...
Polymer({
  is: 'on-ready',
  properties: { val: { type: String, notify: true, value: 'on-ready-default-value' } },
...
Polymer({
  is: 'on-timeout',
  properties: { val: { type: String, notify: true, value: 'on-timeout-default-value' } },
  attached: function () {
    setTimeout(function () {
      this.val = 'on-timeout';
    }.bind(this), 10);
