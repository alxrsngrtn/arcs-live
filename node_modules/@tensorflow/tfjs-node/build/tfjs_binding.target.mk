...
cmd_binding_gyp_tfjs_binding_target_deps_stage = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(builddir); node /Users/plindner/arcs/clean/node_modules/@tensorflow/tfjs-node/scripts/deps-stage.js symlink "$(builddir)"
...
$(builddir)/libtensorflow.so: /Users/plindner/arcs/clean/node_modules/@tensorflow/tfjs-node/scripts/deps-stage.js FORCE_DO_CMD
...
INCS_Debug := \
	...
	-I$(srcdir)/.. \
	-I/Users/plindner/arcs/clean/node_modules/@tensorflow/tfjs-node/deps/include
