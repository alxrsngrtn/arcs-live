...
export declare class Recipe implements Cloneable<Recipe> {
    ...
    get handles(): Handle[];
    set handles(handles: Handle[]);
    get slots(): Slot[];
    set slots(slots: Slot[]);
    get connectionConstraints(): ConnectionConstraint[];
    get obligations(): ConnectionConstraint[];
    get verbs(): string[];
    set verbs(verbs: string[]);
