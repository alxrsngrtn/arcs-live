"main";// http://www.rajdeepd.com/articles/chrome/localstrg/LocalStorageSample.htm
...
(function () {
  ...
  Storage.prototype.___save___ = function () {
    ...
    , function (e) {
      ...
      if (e) {
        _e8d‍.g.console.error('Could not write to database', self.___priv_bk___.path);
        _e8d‍.g.console.error(e);
        return;
      }
