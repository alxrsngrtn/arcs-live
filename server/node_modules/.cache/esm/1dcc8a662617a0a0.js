...
var defaultLogHandler = function (instance, logType) {
    ...
    switch (logType) {
        ...
        case exports.LogLevel.DEBUG:
            _261‍.g.console.log.apply(_261‍.g.console, ["[" + now + "]  " + instance.name + ":"].concat(args));
            break;
        case exports.LogLevel.VERBOSE:
            _261‍.g.console.log.apply(_261‍.g.console, ["[" + now + "]  " + instance.name + ":"].concat(args));
            break;
        case exports.LogLevel.INFO:
            _261‍.g.console.info.apply(_261‍.g.console, ["[" + now + "]  " + instance.name + ":"].concat(args));
            break;
        case exports.LogLevel.WARN:
            _261‍.g.console.warn.apply(_261‍.g.console, ["[" + now + "]  " + instance.name + ":"].concat(args));
            break;
        case exports.LogLevel.ERROR:
            _261‍.g.console.error.apply(_261‍.g.console, ["[" + now + "]  " + instance.name + ":"].concat(args));
            break;
        default:
