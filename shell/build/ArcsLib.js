...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__particle_js__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__search_js__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__slot_js__ = __webpack_require__(93);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__digest_web_js__ = __webpack_require__(35);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
class Recipe {
  ...
  newConnectionConstraint(from, fromConnection, to, toConnection, direction) {
    this._connectionConstraints.push(new __WEBPACK_IMPORTED_MODULE_2__connection_constraint_js__["a" /* ConnectionConstraint */](from, fromConnection, to, toConnection, direction));
  }
  ...
  newParticle(name) {
    let particle = new __WEBPACK_IMPORTED_MODULE_3__particle_js__["a" /* Particle */](this, name);
  ...
  newHandle() {
    let handle = new __WEBPACK_IMPORTED_MODULE_6__handle_js__["a" /* Handle */](this);
    this._handles.push(handle);
    return handle;
  }

  newSlot(name) {
    let slot = new __WEBPACK_IMPORTED_MODULE_5__slot_js__["a" /* Slot */](this, name);
  ...
  _findDuplicate(items, options) {
    ...
    if (duplicateHandle && options && options.errors) {
      options.errors.set(duplicateHandle, `Has Duplicate ${duplicateHandle instanceof __WEBPACK_IMPORTED_MODULE_6__handle_js__["a" /* Handle */] ? 'Handle' : 'Slot'} '${duplicateHandle.id}'`);
    }
  ...
  setSearchPhrase(phrase) {
    ...
    if (phrase) {
      this._search = new __WEBPACK_IMPORTED_MODULE_4__search_js__["a" /* Search */](phrase);
    }
  }
  ...
  async digest() {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__digest_web_js__["a" /* digest */])(this.toString());
  }
  ...
  normalize(options) {
    ...
    connections.sort(__WEBPACK_IMPORTED_MODULE_7__util_js__["a" /* compareComparables */]);
    ...
    slotConnections.sort(__WEBPACK_IMPORTED_MODULE_7__util_js__["a" /* compareComparables */]);
    ...
    orphanedHandles.sort(__WEBPACK_IMPORTED_MODULE_7__util_js__["a" /* compareComparables */]);
    handles.push(...orphanedHandles);

    let orphanedParticles = this._particles.filter(particle => !seenParticles.has(particle));
    orphanedParticles.sort(__WEBPACK_IMPORTED_MODULE_7__util_js__["a" /* compareComparables */]);
    particles.push(...orphanedParticles);

    let orphanedSlots = this._slots.filter(slot => !seenSlots.has(slot));
    orphanedSlots.sort(__WEBPACK_IMPORTED_MODULE_7__util_js__["a" /* compareComparables */]);
    ...
    this._slots = slots;
    this._connectionConstraints.sort(__WEBPACK_IMPORTED_MODULE_7__util_js__["a" /* compareComparables */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__schema_js__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__walker_base_js__ = __webpack_require__(94);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
class Walker extends __WEBPACK_IMPORTED_MODULE_1__walker_base_js__["a" /* WalkerBase */] {
  onResult(result) {
...
Walker.Permuted = __WEBPACK_IMPORTED_MODULE_1__walker_base_js__["a" /* WalkerBase */].Permuted;
Walker.Independent = __WEBPACK_IMPORTED_MODULE_1__walker_base_js__["a" /* WalkerBase */].Independent;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shape_js__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__particle_spec_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__schema_js__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__type_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__recipe_util_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__storage_storage_provider_factory_js__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__manifest_meta_js__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__recipe_type_checker_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__recipe_digest_web_js__ = __webpack_require__(35);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class Manifest {
  constructor({id}) {
    ...
    this._meta = new __WEBPACK_IMPORTED_MODULE_10__manifest_meta_js__["a" /* ManifestMeta */]();
    this._resources = {};
  ...
  get storageProviderFactory() {
    if (this._storageProviderFactory == undefined)
      this._storageProviderFactory = new __WEBPACK_IMPORTED_MODULE_9__storage_storage_provider_factory_js__["a" /* StorageProviderFactory */](this.id);
  ...
  * _findAll(manifestFinder) {
  ...
  findTypeByName(name) {
    ...
    if (schema)
      return __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].newEntity(schema);
    let shape = this.findShapeByName(name);
    if (shape)
      return __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].newInterface(shape);
    return null;
  }
  ...
  findStorageByType(type, options={}) {
    ...
    function typePredicate(store) {
      ...
      if (subtype) {
        let [left, right] = __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].unwrapPair(store.type, resolvedType);
...
${e.message}
    ...
    let visitor = new class extends ManifestVisitor {
      ...
      visit(node, visitChildren) {
        ...
        case 'schema-inline': {
          ...
          for (let {name, type} of node.fields) {
            for (let schema of schemas) {
              if (!type) {
                ...
                if (externalType && !__WEBPACK_IMPORTED_MODULE_4__schema_js__["a" /* Schema */].typesEqual(externalType, type)) {
          ...
          let schema = new __WEBPACK_IMPORTED_MODULE_4__schema_js__["a" /* Schema */]({
            names,
            fields,
          });
          for (let alias of aliases) {
            schema = __WEBPACK_IMPORTED_MODULE_4__schema_js__["a" /* Schema */].union(alias, schema);
            if (!schema) {
              throw new ManifestError(
                  node.location,
          ...
          node.model = __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].newEntity(schema);
          return;
        }
        case 'variable-type': {
          let constraint = node.constraint && node.constraint.model;
          node.model = __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].newVariable({name: node.name, constraint});
          return;
        }
        case 'reference-type': {
          ...
          if (resolved.schema) {
            node.model = __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].newEntity(resolved.schema);
          } else if (resolved.shape) {
            node.model = __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].newInterface(resolved.shape);
          } else {
        ...
        case 'list-type':
          node.model = __WEBPACK_IMPORTED_MODULE_7__type_js__["a" /* Type */].newCollection(node.type.model);
          return;
        default:
          return;
        }
  ...
  static _processSchema(manifest, schemaItem) {
    ...
    for (let parent of schemaItem.parents) {
      ...
      for (let [name, type] of Object.entries(result.fields)) {
        if (fields[name] && !__WEBPACK_IMPORTED_MODULE_4__schema_js__["a" /* Schema */].typesEqual(fields[name], type)) {
    ...
    let schema = new __WEBPACK_IMPORTED_MODULE_4__schema_js__["a" /* Schema */](model);
    if (schemaItem.alias) {
      schema.isAlias = true;
    }
  ...
  static _processParticle(manifest, particleItem, loader) {
    ...
    let particleSpec = new __WEBPACK_IMPORTED_MODULE_3__particle_spec_js__["a" /* ParticleSpec */](particleItem);
  ...
  static _processShape(manifest, shapeItem) {
    ...
    let shape = new __WEBPACK_IMPORTED_MODULE_6__shape_js__["a" /* Shape */](shapeItem.name, handles, slots);
  ...
  static async _processRecipe(manifest, recipeItem, loader) {
    ...
    if (items.search) {
      recipe.search = new __WEBPACK_IMPORTED_MODULE_5__recipe_search_js__["a" /* Search */](items.search.phrase, items.search.tokens);
    }
    ...
    for (let [particle, item] of items.byParticle) {
      for (let connectionItem of item.connections) {
        ...
        if (connectionItem.target && connectionItem.target.particle) {
          ...
          let type = __WEBPACK_IMPORTED_MODULE_11__recipe_type_checker_js__["a" /* TypeChecker */].restrictType(connection.type, hostedParticle);
          if (!type) {
            throw new ManifestError(
                connectionItem.target.location,
          ...
          let particleSpecHash = await __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__recipe_digest_web_js__["a" /* digest */])(JSON.stringify(hostedParticleLiteral));
  ...
  static async _processStore(manifest, item, loader) {
    ...
    if (unitType.isEntity) {
      ...
      if (!item.id && !hasSerializedId) {
        let entityHash = await __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12__recipe_digest_web_js__["a" /* digest */])(JSON.stringify(entities.map(entity => entity.rawData)));
        id = `${id}:${entityHash}`;
      }
    }
  ...
  _newRecipe(name) {
    let recipe = new __WEBPACK_IMPORTED_MODULE_2__recipe_recipe_js__["a" /* Recipe */](name);
  ...
  toString(options) {
    ...
    let handles = [...this.handles].sort(__WEBPACK_IMPORTED_MODULE_8__recipe_util_js__["a" /* compareComparables */]);
    handles.forEach(h => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__type_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__particle_spec_js__ = __webpack_require__(10);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
    ...
    switch (token.extra) {
      ...
      default: {
        ...
        if (token._handleConn.type.isInterface) {
          let particleSpec = __WEBPACK_IMPORTED_MODULE_2__particle_spec_js__["a" /* ParticleSpec */].fromLiteral(await token._handle.get());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__strategies_convert_constraints_to_connections_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__strategies_assign_remote_handles_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__strategies_copy_remote_handles_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__strategies_assign_handles_by_tag_and_type_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__strategies_init_population_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__strategies_map_slots_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__strategies_match_particle_by_verb_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__strategies_match_recipe_by_verb_js__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__strategies_name_unnamed_connections_js__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__strategies_add_use_handles_js__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__strategies_create_description_handle_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__strategies_init_search_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__strategies_search_tokens_to_particles_js__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__strategies_fallback_fate_js__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__strategies_group_handle_connections_js__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__strategies_match_free_handles_to_connections_js__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__strategies_create_handles_js__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__strategies_resolve_recipe_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__speculator_js__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__tracelib_trace_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__debug_strategy_explorer_adapter_js__ = __webpack_require__(76);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
class Planner {
  ...
  async plan(timeout, generations) {
    let trace = __WEBPACK_IMPORTED_MODULE_24__tracelib_trace_js__["a" /* default */].start({cat: 'planning', name: 'Planner::plan', overview: true, args: {timeout}});
    timeout = timeout || -1;
    let allResolved = [];
  ...
  async suggest(timeout, generations, speculator) {
    let trace = __WEBPACK_IMPORTED_MODULE_24__tracelib_trace_js__["a" /* default */].start({cat: 'planning', name: 'Planner::suggest', overview: true, args: {timeout}});
    if (!generations && this._arc._debugging) generations = [];
    let plans = await trace.wait(this.plan(timeout, generations));
    let suggestions = [];
    speculator = speculator || new __WEBPACK_IMPORTED_MODULE_23__speculator_js__["a" /* Speculator */]();
    ...
    if (this._arc._debugging) {
      __WEBPACK_IMPORTED_MODULE_25__debug_strategy_explorer_adapter_js__["a" /* StrategyExplorerAdapter */].processGenerations(generations);
    }
...
Planner.ResolutionStrategies = [
  __WEBPACK_IMPORTED_MODULE_17__strategies_search_tokens_to_particles_js__["a" /* SearchTokensToParticles */],
  __WEBPACK_IMPORTED_MODULE_19__strategies_group_handle_connections_js__["a" /* GroupHandleConnections */],
  __WEBPACK_IMPORTED_MODULE_18__strategies_fallback_fate_js__["a" /* FallbackFate */],
  __WEBPACK_IMPORTED_MODULE_21__strategies_create_handles_js__["a" /* CreateHandles */],
  ...
  __WEBPACK_IMPORTED_MODULE_20__strategies_match_free_handles_to_connections_js__["a" /* MatchFreeHandlesToConnections */],
  __WEBPACK_IMPORTED_MODULE_22__strategies_resolve_recipe_js__["a" /* ResolveRecipe */]
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__type_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__entity_js__ = __webpack_require__(31);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recipe_walker_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_recipe_js__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__strategizer_strategizer_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recipe_recipe_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_walker_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_recipe_util_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__platform_assert_web_js__ = __webpack_require__(0);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_recipe_util_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__map_slots_js__ = __webpack_require__(20);
// Copyright (c) 2018 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dom_particle_js__ = __webpack_require__(14);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slot_js__ = __webpack_require__(38);
...
class DomSlot extends __WEBPACK_IMPORTED_MODULE_1__slot_js__["a" /* Slot */] {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slot_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dom_slot_js__ = __webpack_require__(23);
...
class Affordance {
  ...
  static forName(name) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(_affordances[name], `Unsupported affordance ${name}`);
...
let _affordances = {};
[
  {name: 'dom', slotClass: __WEBPACK_IMPORTED_MODULE_2__dom_slot_js__["a" /* DomSlot */], contextClass: __WEBPACK_IMPORTED_MODULE_3__dom_context_js__["b" /* DomContext */], descriptionFormatter: __WEBPACK_IMPORTED_MODULE_4__description_dom_formatter_js__["a" /* DescriptionDomFormatter */]},
  {name: 'dom-touch', slotClass: __WEBPACK_IMPORTED_MODULE_2__dom_slot_js__["a" /* DomSlot */], contextClass: __WEBPACK_IMPORTED_MODULE_3__dom_context_js__["b" /* DomContext */], descriptionFormatter: __WEBPACK_IMPORTED_MODULE_4__description_dom_formatter_js__["a" /* DescriptionDomFormatter */]},
  {name: 'vr', slotClass: __WEBPACK_IMPORTED_MODULE_2__dom_slot_js__["a" /* DomSlot */], contextClass: __WEBPACK_IMPORTED_MODULE_3__dom_context_js__["b" /* DomContext */], descriptionFormatter: __WEBPACK_IMPORTED_MODULE_4__description_dom_formatter_js__["a" /* DescriptionDomFormatter */]},
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__particle_spec_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__type_js__ = __webpack_require__(3);
...
/* harmony export (immutable) */ __webpack_exports__["b"] = DomContext;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SetDomContext;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__entity_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__symbols_js__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__particle_spec_js__ = __webpack_require__(10);
/** @license
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_vm_web_js__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dom_particle_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__multiplexer_dom_particle_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__transformation_dom_particle_js__ = __webpack_require__(22);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__particle_spec_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__transformation_dom_particle_js__ = __webpack_require__(22);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__relevance_js__ = __webpack_require__(95);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class Speculator {
  ...
  async speculate(arc, plan, hash) {
    ...
    let relevance = new __WEBPACK_IMPORTED_MODULE_2__relevance_js__["a" /* Relevance */](arc.getHandlesState());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__handle_mapper_base_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__ = __webpack_require__(0);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__strategizer_strategizer_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_recipe_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_walker_js__ = __webpack_require__(4);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
class CreateDescriptionHandle extends __WEBPACK_IMPORTED_MODULE_1__strategizer_strategizer_js__["b" /* Strategy */] {
  async generate(inputParams) {
          ...
          return recipe => {
            ...
            combination.forEach(({spec, innerRecipe}) => {
              if (spec) {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(innerRecipe);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__type_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__handle_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__outer_PEC_js__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__fake_pec_factory_js__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__storage_storage_provider_factory_js__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__scheduler_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__devtools_shared_arc_registry_js__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__id_js__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__debug_arc_debug_handler_js__ = __webpack_require__(73);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class Arc {
  constructor({id, context, pecFactory, slotComposer, loader, storageKey, storageProviderFactory, speculative, scheduler}) {
    ...
    this._recipes = [];
    this._loader = loader;
    this._scheduler = scheduler || new __WEBPACK_IMPORTED_MODULE_10__scheduler_js__["a" /* Scheduler */]();
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11__devtools_shared_arc_registry_js__["a" /* registerArc */])(this);
...
${this.activeRecipe.toString()}`;
  ...
  static async deserialize({serialization, pecFactory, slotComposer, loader, fileName, context}) {
    ...
    let options = {errors: new Map()};
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(recipe.normalize(options), `Couldn't normalize recipe ${recipe.toString()}:\n${[...options.errors.values()].join('\n')}`);
  ...
  _instantiateParticle(recipeParticle) {
    ...
    for (let [name, connection] of Object.entries(recipeParticle.connections)) {
      if (!connection.handle) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(connection.isOptional);
        continue;
      }
      let handle = this.findHandleById(connection.handle.id);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(handle, `can't find handle of id ${connection.handle.id}`);
      this._connectParticleToHandle(id, recipeParticle, name, handle);
    }

    // At least all non-optional connections must be resolved
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(handleMap.handles.size >= handleMap.spec.connections.filter(c => !c.isOptional).length,
  ...
  async instantiate(recipe, innerArc) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(recipe.isResolved(), 'Cannot instantiate an unresolved recipe');
    ...
    for (let recipeHandle of handles) {
      if (['copy', 'create'].includes(recipeHandle.fate)) {
        ...
        if (recipeHandle.fate == 'create')
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(type.maybeEnsureResolved(), `Can't assign resolved type to ${type}`);

        type = type.resolvedType();
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(type.isResolved(), `Can't create handle for unresolved type ${type}`);
        ...
        if (recipeHandle.fate === 'copy') {
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(copiedHandle._version !== null);
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(storageKey, `couldn't find storage key for handle '${recipeHandle}'`);
      let handle = await this._storageProviderFactory.connect(recipeHandle.id, recipeHandle.type, storageKey);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(handle, `handle '${recipeHandle.id}' was not found`);
    }
  ...
  _connectParticleToHandle(particleId, particle, name, targetHandle) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(targetHandle, 'no target handle provided');
    let handleMap = this.particleHandleMaps.get(particleId);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(handleMap.spec.connectionMap.get(name) !== undefined, 'can\'t connect handle to a connection that doesn\'t exist');
    handleMap.handles.set(name, targetHandle);
  }

  async createHandle(type, name, id, tags, storageKey) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(type instanceof __WEBPACK_IMPORTED_MODULE_1__type_js__["a" /* Type */], `can't createHandle with type ${type} that isn't a Type`);
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(handle, 'handle with id ${id} already exists');
    handle.name = name;
  ...
  _registerHandle(handle, tags) {
    ...
    tags.forEach(tag => __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(tag.startsWith('#'),
  ...
  getHandleDescription(handle) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(handle, 'Cannot fetch description for nonexistent handle');
  ...
  newCommit(entityMap) {
    ...
    for (let [entity, handle] of entityMap.entries()) {
      new __WEBPACK_IMPORTED_MODULE_2__handle_js__["a" /* handleFor */](handle).store(entity);
    }
  }
  ...
  toContextString(options) {
    let results = [];
    let handles = [...this._handlesById.values()].sort(__WEBPACK_IMPORTED_MODULE_7__recipe_util_js__["a" /* compareComparables */]);
    handles.forEach(v => {
  ...
  initDebug() {
    new __WEBPACK_IMPORTED_MODULE_13__debug_arc_debug_handler_js__["a" /* ArcDebugHandler */](this);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__type_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__strategies_init_search_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__planner_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__speculator_js__ = __webpack_require__(39);
...
class Planificator {
  ...
  _init() {
    ...
    if (this._arc.pec.slotComposer) {
      let suggestionComposer = new __WEBPACK_IMPORTED_MODULE_5__suggestion_composer_js__["a" /* SuggestionComposer */](this._arc.pec.slotComposer);
  ...
  set suggestFilter(suggestFilter) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(!suggestFilter.showAll || !suggestFilter.search);
  ...
  setSearch(search) {
    ...
    if (this._arc.search !== search) {
      ...
      this.requestPlanning({}, {
        ...
        strategies: [__WEBPACK_IMPORTED_MODULE_2__strategies_init_search_js__["a" /* InitSearch */]].concat(__WEBPACK_IMPORTED_MODULE_3__planner_js__["a" /* Planner */].ResolutionStrategies).map(strategy => new strategy(this._arc)),
        append: true
      });
    }
  }
  ...
  onPlanInstantiated(plan) {
    ...
    if (!this._current.plans.find(currentPlan => currentPlan.plan == plan)) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(false, `The plan being instantiated (${plan.description}) doesn't appear in the current list of plans`);
    }
  ...
  async _doNextPlans(options) {
    ...
    let planner = new __WEBPACK_IMPORTED_MODULE_3__planner_js__["a" /* Planner */]();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__affordance_js__ = __webpack_require__(28);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class SlotComposer {
  ...
  constructor(options) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* default */])(this._affordance.slotClass);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__runtime_loader_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__runtime_particle_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__runtime_dom_particle_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__runtime_multiplexer_dom_particle_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__runtime_transformation_dom_particle_js__ = __webpack_require__(22);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony default export */ __webpack_exports__["a"] = ((function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c49 = function(direction, type, name) {
            if (direction == 'host') {
        ...
        peg$c52 = function(direction, type, name) {return name == 'consume' || name == 'provide'},
        peg$c53 = "must",
        peg$c54 = peg$literalExpectation("must", false),
        peg$c55 = "consume",
        peg$c56 = peg$literalExpectation("consume", false),
        peg$c57 = "provide",
        peg$c58 = peg$literalExpectation("provide", false),
        peg$c59 = "set of",
        peg$c60 = peg$literalExpectation("set of", false),
        peg$c61 = function(isRequired, direction, isSet, name) {
            return {
              kind: 'shape-slot',
              location: location(),
        ...
        peg$c62 = "meta",
        peg$c63 = peg$literalExpectation("meta", false),
        peg$c64 = function(items) {
          items = items ? extractIndented(items): [];
          return {kind: 'meta', items: items, location: location()};
        },
        peg$c65 = "name",
        peg$c66 = peg$literalExpectation("name", false),
        peg$c67 = ":",
        ...
        peg$c70 = "storageKey",
        peg$c71 = peg$literalExpectation("storageKey", false),
        peg$c72 = function(key) {
          return {key: 'storageKey', value: key, location: location(), kind: 'storageKey' }
        },
        peg$c73 = "particle",
        peg$c74 = peg$literalExpectation("particle", false),
        peg$c75 = function(name, verbs, implFile, items) {
            let args = [];
            let affordance = [];
            let slots = [];
        ...
        peg$c77 = function(arg, dependentConnections) {
        ...
        peg$c80 = function(direction, type, isOptional, name) {
            return {
        ...
        peg$c81 = "inout",
        peg$c82 = peg$literalExpectation("inout", false),
        peg$c83 = "out",
        peg$c84 = peg$literalExpectation("out", false),
        peg$c85 = "host",
        peg$c86 = peg$literalExpectation("host", false),
        peg$c87 = function() {
            return text();
          },
        peg$c88 = "[",
        ...
        peg$c97 = function(name, constraint) {
            return {
              kind: 'variable-type',
              location: location(),
              name,
        ...
        peg$c100 = "affordance",
        peg$c101 = peg$literalExpectation("affordance", false),
        peg$c102 = "dom-touch",
        peg$c103 = peg$literalExpectation("dom-touch", false),
        peg$c104 = "dom",
        peg$c105 = peg$literalExpectation("dom", false),
        peg$c106 = "vr",
        peg$c107 = peg$literalExpectation("vr", false),
        peg$c108 = "voice",
        peg$c109 = peg$literalExpectation("voice", false),
        peg$c110 = function(affordance) {
            return {
        ...
        peg$c111 = function(isRequired, isSet, name, tags, items) {
            let formFactor = null;
            let providedSlots = [];
            items = optional(items, extractIndented, []);
            items.forEach(item => {
        ...
        peg$c112 = "formFactor",
        peg$c113 = peg$literalExpectation("formFactor", false),
        peg$c114 = "fullscreen",
        peg$c115 = peg$literalExpectation("fullscreen", false),
        peg$c116 = "big",
        peg$c117 = peg$literalExpectation("big", false),
        peg$c118 = "medium",
        peg$c119 = peg$literalExpectation("medium", false),
        peg$c120 = "small",
        peg$c121 = peg$literalExpectation("small", false),
        peg$c122 = function(formFactor) {
            return {
              kind: 'form-factor',
              location: location(),
              formFactor
        ...
        peg$c124 = "handle",
        peg$c125 = peg$literalExpectation("handle", false),
        peg$c126 = function(handle) {
            return {
        ...
        peg$c127 = function(pattern, handleDescriptions) {
            return {
              kind: 'description',
              location: location(),
              description: [
        ...
        peg$c128 = function(name, pattern) {
            return {
        ...
        peg$c135 = function(ref, name, connections) {
            let handleConnections = [];
            let slotConnections = [];
            if (connections) {
        ...
        peg$c136 = function(param, dir, target) {
            return {
        ...
        peg$c137 = function(ref, name, providedSlots) {
            return {
        ...
        peg$c140 = function(from, direction, to) {
            return {
              kind: 'connection',
              location: location(),
              direction,
        ...
        peg$c143 = "tokens",
        peg$c144 = peg$literalExpectation("tokens", false),
        peg$c145 = function(phrase, tokens) {
            return {
              kind: 'search',
              location: location(),
              phrase,
        ...
        peg$c154 = function(ident, param, tags) {
            let particle = null;
            let name = null;
            if (ident) {
              if (/^[A-Z]/.test(ident)) {
        ...
        peg$c156 = "use",
        peg$c157 = peg$literalExpectation("use", false),
        peg$c158 = "map",
        peg$c159 = peg$literalExpectation("map", false),
        peg$c160 = "create",
        peg$c161 = peg$literalExpectation("create", false),
        peg$c162 = "copy",
        peg$c163 = peg$literalExpectation("copy", false),
        peg$c164 = function(type, ref, name) {
            return {
              kind: 'handle',
              location: location(),
              name: optional(name, name => name[1], null),
        ...
        peg$c172 = function(head, tail) { return [head, ...(tail && tail[1] || [])]; },
        peg$c173 = function(tags) { return tags; },
        ...
        peg$c176 = "particle can",
        peg$c177 = peg$literalExpectation("particle can", false),
        peg$c178 = function(verb, tags) {
            return {
              kind: 'particle-ref',
              location: location(),
              verbs: [verb],
        ...
        peg$c182 = "slot",
        peg$c183 = peg$literalExpectation("slot", false),
        peg$c184 = function(ref, name) {
            return {
              kind: 'slot',
              location: location(),
              ref: optional(ref, ref => ref[1], null),
        ...
        peg$c189 = function(names, fields) {
            return {
              kind: 'schema-inline',
              location: location(),
        ...
        peg$c191 = "schema",
        peg$c192 = peg$literalExpectation("schema", false),
        peg$c193 = function(names, parents) {
            return {
        ...
        peg$c194 = "alias",
        peg$c195 = peg$literalExpectation("alias", false),
        peg$c196 = function(spec, alias, items) {
        ...
        peg$c201 = "normative",
        peg$c202 = peg$literalExpectation("normative", false),
        peg$c203 = "optional",
        peg$c204 = peg$literalExpectation("optional", false),
        peg$c205 = function(sectionType, fields) {
            return {
              kind: 'schema-section',
              location: location(),
              sectionType,
        ...
        peg$c207 = "Text",
        peg$c208 = peg$literalExpectation("Text", false),
        peg$c209 = "URL",
        peg$c210 = peg$literalExpectation("URL", false),
        peg$c211 = "Number",
        peg$c212 = peg$literalExpectation("Number", false),
        peg$c213 = "Boolean",
        peg$c214 = peg$literalExpectation("Boolean", false),
        peg$c215 = "Bytes",
        peg$c216 = peg$literalExpectation("Bytes", false),
        peg$c217 = "Object",
        peg$c218 = peg$literalExpectation("Object", false),
        peg$c219 = "or",
        ...
        peg$c233 = /^[^`]/,
        peg$c234 = peg$classExpectation(["`"], true, false),
        peg$c235 = function(pattern) { return pattern.join(''); },
        peg$c236 = "'",
        peg$c237 = peg$literalExpectation("'", false),
        peg$c238 = /^[^']/,
        peg$c239 = peg$classExpectation(["'"], true, false),
        peg$c240 = function(id) {return id.join('')},
        peg$c241 = /^[A-Z]/,
        peg$c242 = peg$classExpectation([["A", "Z"]], false, false),
        peg$c243 = /^[a-z0-9_]/i,
        peg$c244 = peg$classExpectation([["a", "z"], ["0", "9"], "_"], false, true),
        peg$c245 = function(ident) {return text()},
        peg$c246 = /^[a-z]/,
        peg$c247 = peg$classExpectation([["a", "z"]], false, false),
        peg$c248 = /^[ ]/,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__devtools_channel_provider_js__ = __webpack_require__(9);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__devtools_channel_provider_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__planner_js__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__loader_js__ = __webpack_require__(33);
// @license
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__random_js__ = __webpack_require__(87);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class Id {
  ...
  static newSessionId() {
    let session = Math.floor(__WEBPACK_IMPORTED_MODULE_1__random_js__["a" /* Random */].next() * Math.pow(2, 50)) + '';
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__type_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__handle_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_channel_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__storage_proxy_js__ = __webpack_require__(96);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_channel_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__manifest_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_recipe_resolver_js__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__arc_exceptions_js__ = __webpack_require__(69);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class ConnectionConstraint {
  constructor(from, fromConnection, to, toConnection, direction) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* default */])(direction);
  ...
  _compareTo(other) {
    let cmp;
    if ((cmp = __WEBPACK_IMPORTED_MODULE_0__util_js__["b" /* compareStrings */](this.fromParticle.name, other.fromParticle.name)) != 0) return cmp;
    if ((cmp = __WEBPACK_IMPORTED_MODULE_0__util_js__["b" /* compareStrings */](this.fromConnection, other.fromConnection)) != 0) return cmp;
    if ((cmp = __WEBPACK_IMPORTED_MODULE_0__util_js__["b" /* compareStrings */](this.toParticle.name, other.toParticle.name)) != 0) return cmp;
    if ((cmp = __WEBPACK_IMPORTED_MODULE_0__util_js__["b" /* compareStrings */](this.toConnection, other.toConnection)) != 0) return cmp;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slot_connection_js__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__handle_connection_js__ = __webpack_require__(89);
...
class Particle {
  ...
  _compareTo(other) {
    ...
    // TODO: spec?
    if ((cmp = __WEBPACK_IMPORTED_MODULE_3__util_js__["c" /* compareArrays */](this._tags, other._tags, __WEBPACK_IMPORTED_MODULE_3__util_js__["b" /* compareStrings */])) != 0) return cmp;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__strategies_resolve_recipe_js__ = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__storage_provider_base_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_firebase_web_js__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__key_base_js__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__platform_btoa_web_js__ = __webpack_require__(64);
// @
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tracelib_trace_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__storage_provider_base_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__key_base_js__ = __webpack_require__(40);
// @
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__strategizer_strategizer_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__convert_constraints_to_connections_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assign_remote_handles_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__copy_remote_handles_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assign_handles_by_tag_and_type_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__init_population_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__map_slots_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__match_particle_by_verb_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__match_recipe_by_verb_js__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__add_use_handles_js__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__create_description_handle_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__init_search_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__search_tokens_to_particles_js__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__fallback_fate_js__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__group_handle_connections_js__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__match_free_handles_to_connections_js__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__create_handles_js__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__resolve_recipe_js__ = __webpack_require__(21);
// Copyright (c) 2018 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
class TupleFields {
  ...
  static fromLiteral(literal) {
    return new TupleFields(literal.map(a => __WEBPACK_IMPORTED_MODULE_1__type_js__["a" /* Type */].fromLiteral(a)));
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__runtime_slot_composer_js__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__runtime_dom_slot_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__runtime_type_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__browser_loader_js__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tracelib_trace_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__runtime_scheduler_js__ = __webpack_require__(24);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
const Arcs = {
  ...
  Tracing: __WEBPACK_IMPORTED_MODULE_9__tracelib_trace_js__["a" /* default */],
  Scheduler: __WEBPACK_IMPORTED_MODULE_10__runtime_scheduler_js__["a" /* Scheduler */]
};
