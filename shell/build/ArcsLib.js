...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_digest_web_js__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__particle_js__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__search_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__slot_js__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__handle_js__ = __webpack_require__(7);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__walker_base_js__ = __webpack_require__(100);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shape_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__schema_js__ = __webpack_require__(21);
...
class Type {
    ...
    _cloneWithResolutions(variableMap) {
        ...
        if (this.data instanceof __WEBPACK_IMPORTED_MODULE_1__shape_js__["a" /* Shape */] || this.data instanceof Type) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ts_build_type_js__ = __webpack_require__(4);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
class Handle {
  ...
  _copyInto(recipe) {
    ...
    if (handle == undefined) {
      ...
      handle._type = this._type ? __WEBPACK_IMPORTED_MODULE_3__ts_build_type_js__["a" /* Type */].fromLiteral(this._type.toLiteral()) : undefined;
  ...
  mergeInto(handle) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this.recipe == handle.recipe, 'Cannot merge handles from different recipes.');
  ...
  _mergedFate(fates) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(fates.length > 0, `Cannot merge empty fates list`);
    // Merging handles only used in coalesce-recipe strategy, which is only done for use/create/? fates.
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(!fates.includes('map') && !fates.includes('copy'), `Merging map/copy not supported yet`);
    ...
    if (this.type) {
      ...
      if (this.type.isResolved()) {
        ...
        if (options.showUnresolved && this.type.canEnsureResolved()) {
          let type = __WEBPACK_IMPORTED_MODULE_3__ts_build_type_js__["a" /* Type */].fromLiteral(this.type.toLiteral());
  ...
  static find(recipe, shape) {
    ...
    function _buildNewHCMatches(recipe, shapeHC, match, outputList) {
      ...
      for (let recipeHC of recipe.handleConnections) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(!newMatch.reverse.has(recipeHC.particle) || newMatch.reverse.get(recipeHC.particle) == shapeHC.particle);
    ...
    function _buildNewParticleMatches(recipe, shapeParticle, match, newMatches) {
      ...
      if (matchFound == false) {
        ...
        forward.forEach((value, key) => {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(!newMatch.forward.has(key) || newMatch.forward.get(key) == value);
          newMatch.forward.set(key, value);
        });
        reverse.forEach((value, key) => {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(!newMatch.reverse.has(key) || newMatch.reverse.get(key) == value);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recipe_type_checker_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shape_js__ = __webpack_require__(22);
...
/* harmony export (immutable) */ __webpack_exports__["b"] = ProvidedSlotSpec;
...
class ParticleSpec {
  ...
  static fromLiteral(literal) {
    ...
    let connectionFromLiteral = ({type, direction, name, isOptional, dependentConnections}) =>
      ({type: __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].fromLiteral(type), direction, name, isOptional, dependentConnections: dependentConnections ? dependentConnections.map(connectionFromLiteral) : []});
  ...
  toInterface() {
    return __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].newInterface(this._toShape());
  }
...
class TypeChecker {
  ...
  static processTypeList(baseType, list) {
    let newBaseType = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].newVariable(new __WEBPACK_IMPORTED_MODULE_1__type_variable_js__["a" /* TypeVariable */](''));
    if (baseType) {
  ...
  static _tryMergeTypeVariable(base, onto) {
    let [primitiveBase, primitiveOnto] = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].unwrapPair(base.resolvedType(), onto.resolvedType());
    ...
    if (primitiveBase.isVariable) {
      ...
      return __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].newInterface(result);
    } else {
  ...
  static _tryMergeConstraints(handleType, {type, direction}) {
    let [primitiveHandleType, primitiveConnectionType] = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].unwrapPair(handleType.resolvedType(), type.resolvedType());
    if (primitiveHandleType.isVariable) {
      while (primitiveConnectionType.isCollection) {
        ...
        primitiveHandleType.variable.resolution = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].newCollection(__WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].newVariable(new __WEBPACK_IMPORTED_MODULE_1__type_variable_js__["a" /* TypeVariable */]('a')));
        let unwrap = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].unwrapPair(primitiveHandleType.resolvedType(), primitiveConnectionType);
  ...
  static compareTypes(left, right) {
    ...
    let [leftType, rightType] = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].unwrapPair(resolvedLeft, resolvedRight);
    ...
    if (leftType.isVariable || rightType.isVariable) {
      ...
      return __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].canMergeConstraints(leftType, rightType);
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__recipe_util_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ts_build_storage_storage_provider_factory_js__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__manifest_meta_js__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__recipe_type_checker_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__recipe_connection_constraint_js__ = __webpack_require__(20);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class Manifest {
  constructor({id}) {
    ...
    this._meta = new __WEBPACK_IMPORTED_MODULE_12__manifest_meta_js__["a" /* ManifestMeta */]();
    this._resources = {};
  ...
  get storageProviderFactory() {
    if (this._storageProviderFactory == undefined) {
      this._storageProviderFactory = new __WEBPACK_IMPORTED_MODULE_11__ts_build_storage_storage_provider_factory_js__["a" /* StorageProviderFactory */](this.id);
    }
  ...
  applyMeta(section) {
    if (this._storageProviderFactory !== undefined) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(
  ...
  * _findAll(manifestFinder) {
  ...
  findTypeByName(name) {
    ...
    if (schema) {
      return __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newEntity(schema);
    }
    let shape = this.findShapeByName(name);
    if (shape) {
      return __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newInterface(shape);
    }
    return null;
  }
  ...
  findStoreByType(type, options={}) {
    ...
    function typePredicate(store) {
      ...
      if (subtype) {
        let [left, right] = __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].unwrapPair(store.type, resolvedType);
    ...
    return stores.filter(s => !!__WEBPACK_IMPORTED_MODULE_4__recipe_handle_js__["a" /* Handle */].effectiveType(
...
${e.message}
    ...
    let visitor = new class extends ManifestVisitor {
      ...
      visit(node, visitChildren) {
        ...
        case 'schema-inline': {
          ...
          for (let {name, type} of node.fields) {
            for (let schema of schemas) {
              if (!type) {
                ...
                if (externalType && !__WEBPACK_IMPORTED_MODULE_6__schema_js__["a" /* Schema */].typesEqual(externalType, type)) {
          ...
          let schema = new __WEBPACK_IMPORTED_MODULE_6__schema_js__["a" /* Schema */]({
            names,
            fields,
          });
          for (let alias of aliases) {
            schema = __WEBPACK_IMPORTED_MODULE_6__schema_js__["a" /* Schema */].union(alias, schema);
            if (!schema) {
              throw new ManifestError(
                  node.location,
          ...
          node.model = __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newEntity(schema);
          return;
        }
        case 'variable-type': {
          let constraint = node.constraint && node.constraint.model;
          node.model = __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newVariable({name: node.name, constraint});
          return;
        }
        case 'slot-type': {
          let slotInfo = {};
          ...
          node.model = __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newSlot(slotInfo);
          return;
        }
        case 'reference-type': {
          ...
          if (resolved.schema) {
            node.model = __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newEntity(resolved.schema);
          } else if (resolved.shape) {
            node.model = __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newInterface(resolved.shape);
          } else {
        ...
        case 'list-type':
          node.model = __WEBPACK_IMPORTED_MODULE_9__ts_build_type_js__["a" /* Type */].newCollection(node.type.model);
          return;
        default:
          return;
        }
  ...
  static _processSchema(manifest, schemaItem) {
    ...
    for (let parent of schemaItem.parents) {
      ...
      for (let [name, type] of Object.entries(result.fields)) {
        if (fields[name] && !__WEBPACK_IMPORTED_MODULE_6__schema_js__["a" /* Schema */].typesEqual(fields[name], type)) {
    ...
    let schema = new __WEBPACK_IMPORTED_MODULE_6__schema_js__["a" /* Schema */](model);
    if (schemaItem.alias) {
      schema.isAlias = true;
    }
  ...
  static _processParticle(manifest, particleItem, loader) {
    ...
    let particleSpec = new __WEBPACK_IMPORTED_MODULE_5__particle_spec_js__["a" /* ParticleSpec */](particleItem);
  ...
  static _processShape(manifest, shapeItem) {
    ...
    let shape = new __WEBPACK_IMPORTED_MODULE_8__shape_js__["a" /* Shape */](shapeItem.name, handles, slots);
  ...
  static async _processRecipe(manifest, recipeItem, loader) {
    ...
    let prepareEndpoint = (connection, info) => {
      switch (info.targetType) {
        case 'particle': {
          ...
          return new __WEBPACK_IMPORTED_MODULE_14__recipe_connection_constraint_js__["b" /* ParticleEndPoint */](particle, info.param);
        }
        case 'localName': {
          ...
          if (info.param == null && info.tags.length == 0 &&
            ...
            return new __WEBPACK_IMPORTED_MODULE_14__recipe_connection_constraint_js__["c" /* HandleEndPoint */](items.byName.get(info.name).handle);
          }
          throw new ManifestError(connection.location, `references to particles by local name not yet supported`);
        }
        case 'tag': {
          return new __WEBPACK_IMPORTED_MODULE_14__recipe_connection_constraint_js__["d" /* TagEndPoint */](info.tags);
        }
        default:
    ...
    if (items.search) {
      recipe.search = new __WEBPACK_IMPORTED_MODULE_7__recipe_search_js__["a" /* Search */](items.search.phrase, items.search.tokens);
    }
  ...
  toString(options) {
    ...
    let stores = [...this.stores].sort(__WEBPACK_IMPORTED_MODULE_10__recipe_util_js__["a" /* compareComparables */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__devtools_shared_devtools_broker_js__ = __webpack_require__(61);
/**
 * @license
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_date_web_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__strategizer_strategizer_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__strategies_rulesets_js__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__platform_deviceinfo_web_js__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__strategies_assign_handles_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__strategies_init_population_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__strategies_map_slots_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__strategies_match_particle_by_verb_js__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__strategies_match_recipe_by_verb_js__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__strategies_name_unnamed_connections_js__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__strategies_add_missing_handles_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__strategies_create_description_handle_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__strategies_init_search_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__strategies_search_tokens_to_handles_js__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__strategies_search_tokens_to_particles_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__strategies_group_handle_connections_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__strategies_match_free_handles_to_connections_js__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__strategies_create_handle_group_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__strategies_combined_strategy_js__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__strategies_find_hosted_particle_js__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__strategies_coalesce_recipes_js__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__strategies_resolve_recipe_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__speculator_js__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__tracelib_trace_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__debug_strategy_explorer_adapter_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__debug_devtools_connection_js__ = __webpack_require__(12);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
class Planner {
  ...
  async plan(timeout, generations) {
    let trace = __WEBPACK_IMPORTED_MODULE_25__tracelib_trace_js__["a" /* Tracing */].start({cat: 'planning', name: 'Planner::plan', overview: true, args: {timeout}});
    timeout = timeout || -1;
    let allResolved = [];
  ...
  async suggest(timeout, generations, speculator) {
    let trace = __WEBPACK_IMPORTED_MODULE_25__tracelib_trace_js__["a" /* Tracing */].start({cat: 'planning', name: 'Planner::suggest', overview: true, args: {timeout}});
    if (!generations && __WEBPACK_IMPORTED_MODULE_27__debug_devtools_connection_js__["a" /* DevtoolsConnection */].isConnected) generations = [];
    let plans = await trace.wait(this.plan(timeout, generations));
    let suggestions = [];
    speculator = speculator || new __WEBPACK_IMPORTED_MODULE_24__speculator_js__["a" /* Speculator */]();
    ...
    let results = await trace.wait(Promise.all(planGroups.map(async (group, groupIndex) => {
      ...
      for (let plan of group) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_4__recipe_recipe_util_js__["a" /* RecipeUtil */].matchesRecipe(this._arc._activeRecipe, plan)) {
          this._updateGeneration(generations, hash, (g) => g.active = true);
          continue;
        }

        let planTrace = __WEBPACK_IMPORTED_MODULE_25__tracelib_trace_js__["a" /* Tracing */].start({
          cat: 'speculating',
    ...
    if (generations && __WEBPACK_IMPORTED_MODULE_27__debug_devtools_connection_js__["a" /* DevtoolsConnection */].isConnected) {
      __WEBPACK_IMPORTED_MODULE_26__debug_strategy_explorer_adapter_js__["a" /* StrategyExplorerAdapter */].processGenerations(generations, __WEBPACK_IMPORTED_MODULE_27__debug_devtools_connection_js__["a" /* DevtoolsConnection */].get());
    }
...
Planner.InitializationStrategies = [
  __WEBPACK_IMPORTED_MODULE_7__strategies_init_population_js__["a" /* InitPopulation */],
  __WEBPACK_IMPORTED_MODULE_14__strategies_init_search_js__["a" /* InitSearch */]
];

Planner.ResolutionStrategies = [
  __WEBPACK_IMPORTED_MODULE_16__strategies_search_tokens_to_particles_js__["a" /* SearchTokensToParticles */],
  __WEBPACK_IMPORTED_MODULE_15__strategies_search_tokens_to_handles_js__["a" /* SearchTokensToHandles */],
  __WEBPACK_IMPORTED_MODULE_17__strategies_group_handle_connections_js__["a" /* GroupHandleConnections */],
  __WEBPACK_IMPORTED_MODULE_19__strategies_create_handle_group_js__["a" /* CreateHandleGroup */],
  __WEBPACK_IMPORTED_MODULE_5__strategies_convert_constraints_to_connections_js__["a" /* ConvertConstraintsToConnections */],
  __WEBPACK_IMPORTED_MODULE_8__strategies_map_slots_js__["a" /* MapSlots */],
  __WEBPACK_IMPORTED_MODULE_6__strategies_assign_handles_js__["a" /* AssignHandles */],
  __WEBPACK_IMPORTED_MODULE_9__strategies_match_particle_by_verb_js__["a" /* MatchParticleByVerb */],
  __WEBPACK_IMPORTED_MODULE_10__strategies_match_recipe_by_verb_js__["a" /* MatchRecipeByVerb */],
  __WEBPACK_IMPORTED_MODULE_11__strategies_name_unnamed_connections_js__["a" /* NameUnnamedConnections */],
  __WEBPACK_IMPORTED_MODULE_12__strategies_add_missing_handles_js__["a" /* AddMissingHandles */],
  __WEBPACK_IMPORTED_MODULE_13__strategies_create_description_handle_js__["a" /* CreateDescriptionHandle */],
  __WEBPACK_IMPORTED_MODULE_18__strategies_match_free_handles_to_connections_js__["a" /* MatchFreeHandlesToConnections */],
  __WEBPACK_IMPORTED_MODULE_23__strategies_resolve_recipe_js__["a" /* ResolveRecipe */],
  __WEBPACK_IMPORTED_MODULE_21__strategies_find_hosted_particle_js__["a" /* FindHostedParticle */],
  __WEBPACK_IMPORTED_MODULE_22__strategies_coalesce_recipes_js__["a" /* CoalesceRecipes */]
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dom_particle_base_js__ = __webpack_require__(82);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_fs_web_js__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_vm_web_js__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fetch_web_js__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__platform_assert_web_js__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__converters_jsonldToManifest_js__ = __webpack_require__(73);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__ = __webpack_require__(4);
...
class Schema {
  ...
  get type() {
    return __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__["a" /* Type */].newEntity(this);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_type_checker_js__ = __webpack_require__(10);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
function _fromLiteral(member) {
  if (!!member && typeof member == 'object') {
    return __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__["a" /* Type */].fromLiteral(member);
  }
  return member;
}
...
`;
  ...
  static isTypeVar(reference) {
    return (reference instanceof __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__["a" /* Type */]) && reference.hasProperty(r => r.isVariable);
  }
  ...
  static handlesMatch(shapeHandle, particleHandle) {
    ...
    let [left, right] = __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__["a" /* Type */].unwrapPair(shapeHandle.type, particleHandle.type);
    if (left.isVariable) {
...
class SlotContext {
  constructor(id, name, tags, container, spec, sourceSlotConsumer) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(Boolean(container) != Boolean(spec), `Exactly one of either container or slotSpec may be set`);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(Boolean(spec) == Boolean(spec), `Spec and source slot can only be set together`);
    ...
    this._spec = spec || new __WEBPACK_IMPORTED_MODULE_1__particle_spec_js__["b" /* ProvidedSlotSpec */](name);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SlotContext;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shell_components_xen_xen_template_js__ = __webpack_require__(115);
/**
 * @license
 * Copyright (c) 2018 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class SlotDomConsumer extends __WEBPACK_IMPORTED_MODULE_1__slot_consumer_js__["a" /* SlotConsumer */] {
    ...
    if (Object.keys(content).indexOf('model') >= 0) {
      if (content.model) {
        ...
        if (subId && content.model.items) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this.consumeConn.slotSpec.isSet);
  ...
  _onUpdate(rendering) {
    ...
    if (rendering.templateName) {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(template, `No template for ${rendering.templateName}`);
  ...
  _observe(container) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(container, 'Cannot observe without a container');
  ...
  _stampTemplate(rendering, template) {
    if (!rendering.liveDom) {
      ...
      rendering.liveDom = __WEBPACK_IMPORTED_MODULE_2__shell_components_xen_xen_template_js__["a" /* default */]
          .stamp(template)
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SlotDomConsumer;
...
class AddMissingHandles extends __WEBPACK_IMPORTED_MODULE_0__strategizer_strategizer_js__["b" /* Strategy */] {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AddMissingHandles;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_walker_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_recipe_util_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_connection_constraint_js__ = __webpack_require__(20);
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dom_particle_js__ = __webpack_require__(17);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__particle_execution_host_js__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_handle_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_recipe_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__manifest_js__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ts_build_storage_storage_provider_factory_js__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__debug_devtools_connection_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__id_js__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__debug_arc_debug_handler_js__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__recipe_index_js__ = __webpack_require__(94);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class Arc {
  constructor({id, context, pecFactory, slotComposer, loader, storageKey, storageProviderFactory, speculative, scheduler, recipeIndex}) {
    ...
    this.pec = new __WEBPACK_IMPORTED_MODULE_2__particle_execution_host_js__["a" /* ParticleExecutionHost */](innerPecPort, slotComposer, this, `${pecId}:outer`);
    if (slotComposer) {
      slotComposer.arc = this;
    }
    this._storageProviderFactory = storageProviderFactory || new __WEBPACK_IMPORTED_MODULE_9__ts_build_storage_storage_provider_factory_js__["a" /* StorageProviderFactory */](this.id);
...
${this.activeRecipe.toString()}`;
  ...
  static async deserialize({serialization, pecFactory, slotComposer, loader, fileName, context}) {
    let manifest = await __WEBPACK_IMPORTED_MODULE_5__manifest_js__["a" /* Manifest */].parse(serialization, {loader, fileName, context});
    let arc = new Arc({
  ...
  async createStore(type, name, id, tags, storageKey) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(type instanceof __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__["a" /* Type */], `can't createStore with type ${type} that isn't a Type`);

    if (type.isRelation) {
      type = __WEBPACK_IMPORTED_MODULE_1__ts_build_type_js__["a" /* Type */].newCollection(type);
    }
  ...
  _tagStore(store, tags) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this._storesById.has(store.id) && this._storeTags.has(store), `Store not registered '${store.id}'`);
  ...
  findStoresByType(type, options) {
    ...
    // Quick check that a new handle can fulfill the type contract.
    // Rewrite of this method tracked by https://github.com/PolymerLabs/arcs/issues/1636.
    return stores.filter(s => !!__WEBPACK_IMPORTED_MODULE_3__recipe_handle_js__["a" /* Handle */].effectiveType(
      type, [{type: s.type, direction: s.type.isInterface ? 'host' : 'inout'}]));
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__slot_context_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__hosted_slot_consumer_js__ = __webpack_require__(86);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class SlotComposer {
  ...
  constructor(options) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this._affordance.slotConsumerClass);
    ...
    Object.keys(containerByName).forEach(slotName => {
      this._contexts.push(__WEBPACK_IMPORTED_MODULE_2__slot_context_js__["a" /* SlotContext */].createContextForContainer(
  ...
  findContainerByName(name) {
    ...
    if (contexts.length == 0) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(`No containers for '${name}'`);
    } else if (contexts.length == 1) {
      return contexts[0].container;
    } else {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(`Ambiguous containers for '${name}'`);
    }
  }
  ...
  createHostedSlot(transformationParticle, transformationSlotName, hostedParticleName, hostedSlotName, storeId) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(transformationSlotConsumer,
    ...
    let hostedSlotConsumer = new __WEBPACK_IMPORTED_MODULE_3__hosted_slot_consumer_js__["a" /* HostedSlotConsumer */](transformationSlotConsumer, hostedParticleName, hostedSlotName, hostedSlotId, storeId, this.arc);
  ...
  initializeRecipe(recipeParticles) {
    ...
    recipeParticles.forEach(p => {
      Object.values(p.consumedSlotConnections).forEach(cs => {
        ...
        if (slotConsumer) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(!slotConsumer.consumeConn);
    ...
    newConsumers.forEach(consumer => {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(context, `No context found for ${consumer.consumeConn.getQualifiedName()}`);
  ...
  async renderSlot(particle, slotName, content) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(slotConsumer, `Cannot find slot (or hosted slot) ${slotName} for particle ${particle.name}`);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slot_dom_consumer_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__suggest_dom_consumer_js__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__testing_mock_slot_dom_consumer_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__testing_mock_suggest_dom_consumer_js__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__description_dom_formatter_js__ = __webpack_require__(81);
/**
 * @license
 * Copyright (c) 2018 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
let _affordances = {};
[
  {name: 'dom', slotConsumerClass: __WEBPACK_IMPORTED_MODULE_1__slot_dom_consumer_js__["a" /* SlotDomConsumer */], suggestionConsumerClass: __WEBPACK_IMPORTED_MODULE_2__suggest_dom_consumer_js__["a" /* SuggestDomConsumer */], descriptionFormatter: __WEBPACK_IMPORTED_MODULE_5__description_dom_formatter_js__["a" /* DescriptionDomFormatter */]},
  {name: 'dom-touch', slotConsumerClass: __WEBPACK_IMPORTED_MODULE_1__slot_dom_consumer_js__["a" /* SlotDomConsumer */], suggestionConsumerClass: __WEBPACK_IMPORTED_MODULE_2__suggest_dom_consumer_js__["a" /* SuggestDomConsumer */], descriptionFormatter: __WEBPACK_IMPORTED_MODULE_5__description_dom_formatter_js__["a" /* DescriptionDomFormatter */]},
  {name: 'vr', slotConsumerClass: __WEBPACK_IMPORTED_MODULE_1__slot_dom_consumer_js__["a" /* SlotDomConsumer */], suggestionConsumerClass: __WEBPACK_IMPORTED_MODULE_2__suggest_dom_consumer_js__["a" /* SuggestDomConsumer */], descriptionFormatter: __WEBPACK_IMPORTED_MODULE_5__description_dom_formatter_js__["a" /* DescriptionDomFormatter */]},
  {name: 'mock', slotConsumerClass: __WEBPACK_IMPORTED_MODULE_3__testing_mock_slot_dom_consumer_js__["a" /* MockSlotDomConsumer */], suggestionConsumerClass: __WEBPACK_IMPORTED_MODULE_4__testing_mock_suggest_dom_consumer_js__["a" /* MockSuggestDomConsumer */]}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__particle_spec_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__debug_outer_port_attachment_js__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__debug_devtools_connection_js__ = __webpack_require__(12);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class PECOuterPort extends APIPort {
  constructor(messagePort, arc) {
    ...
    this.registerRedundantInitializer('DefineHandle', {type: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__["a" /* Type */]), name: this.Direct});
    ...
    this.registerHandler('ArcCreateHandle', {callback: this.Direct, arc: this.LocalMapped, type: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__["a" /* Type */]), name: this.Direct});
    this.registerInitializer('CreateHandleCallback', {callback: this.Direct, type: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__["a" /* Type */]), name: this.Direct, id: this.Direct});
...
class PECInnerPort extends APIPort {
  constructor(messagePort) {
    ...
    this.registerInitializerHandler('DefineHandle', {type: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__["a" /* Type */]), name: this.Direct});
    ...
    this.registerCall('ArcCreateHandle', {callback: this.LocalMapped, arc: this.Direct, type: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__["a" /* Type */]), name: this.Direct});
    this.registerInitializerHandler('CreateHandleCallback', {callback: this.LocalMapped, type: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__["a" /* Type */]), name: this.Direct, id: this.Direct});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__symbols_js__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__ = __webpack_require__(4);
// @license
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
...
class Entity {
  ...
  static get type() {
    ...
    return __WEBPACK_IMPORTED_MODULE_2__ts_build_type_js__["a" /* Type */].newEntity(this.key.schema);
  }
}
...
class Search {
  constructor(phrase, unresolvedTokens) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(tokens.length == this.unresolvedTokens.length + this.resolvedTokens.length);
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slot_context_js__ = __webpack_require__(23);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class SlotConsumer {
  ...
  createProvidedContexts() {
    return this.consumeConn.slotSpec.providedSlots.map(
      spec => new __WEBPACK_IMPORTED_MODULE_1__slot_context_js__["a" /* SlotContext */](this.consumeConn.providedSlots[spec.name].id, spec.name, /* tags=*/ [], /* container= */ null, spec, this));
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SlotConsumer;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tracelib_trace_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__relevance_js__ = __webpack_require__(101);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class AssignHandles extends __WEBPACK_IMPORTED_MODULE_0__strategizer_strategizer_js__["b" /* Strategy */] {
  constructor(arc) {
    super();
    this._arc = arc;
  }
    ...
    return __WEBPACK_IMPORTED_MODULE_2__recipe_recipe_js__["a" /* Recipe */].over(this.getResults(inputParams), new class extends __WEBPACK_IMPORTED_MODULE_1__recipe_walker_js__["a" /* Walker */] {
      onHandle(recipe, handle) {
        ...
        let responses = [...stores.keys()].map(store =>
          ((recipe, clonedHandle) => {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__platform_assert_web_js__["a" /* assert */])(store.id);
            ...
            if (clonedHandle.fate == '?') {
              ...
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__platform_assert_web_js__["a" /* assert */])(clonedHandle.fate, stores.get.store);
            }
            return score;
          }));
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AssignHandles;
          ...
          return (outputRecipe, particleForReplacing) => {
            ...
            for (let name in handleConstraints.named) {
              if (handleConstraints.named[name].handle) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__platform_assert_web_js__["a" /* assert */])(applyHandleConstraint(
                    name,
            ...
            for (let connection of handleConstraints.unnamed) {
              if (connection.handle) {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__platform_assert_web_js__["a" /* assert */])(
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assign_handles_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__init_population_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__map_slots_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__match_particle_by_verb_js__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__match_recipe_by_verb_js__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__add_missing_handles_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__create_description_handle_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__init_search_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__search_tokens_to_particles_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__group_handle_connections_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__match_free_handles_to_connections_js__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__resolve_recipe_js__ = __webpack_require__(14);
// Copyright (c) 2018 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
// Code distributed by Google as part of this project is also
...
const ExperimentalPhased = new __WEBPACK_IMPORTED_MODULE_0__strategizer_strategizer_js__["c" /* Ruleset */].Builder().order(
  [
    __WEBPACK_IMPORTED_MODULE_3__init_population_js__["a" /* InitPopulation */],
    __WEBPACK_IMPORTED_MODULE_9__init_search_js__["a" /* InitSearch */]
  ],
  __WEBPACK_IMPORTED_MODULE_10__search_tokens_to_particles_js__["a" /* SearchTokensToParticles */],
  [
    __WEBPACK_IMPORTED_MODULE_6__match_recipe_by_verb_js__["a" /* MatchRecipeByVerb */],
    __WEBPACK_IMPORTED_MODULE_5__match_particle_by_verb_js__["a" /* MatchParticleByVerb */]
  ],
  __WEBPACK_IMPORTED_MODULE_1__convert_constraints_to_connections_js__["a" /* ConvertConstraintsToConnections */],
  __WEBPACK_IMPORTED_MODULE_11__group_handle_connections_js__["a" /* GroupHandleConnections */],
  [
    __WEBPACK_IMPORTED_MODULE_7__add_missing_handles_js__["a" /* AddMissingHandles */],
    __WEBPACK_IMPORTED_MODULE_2__assign_handles_js__["a" /* AssignHandles */],
    __WEBPACK_IMPORTED_MODULE_12__match_free_handles_to_connections_js__["a" /* MatchFreeHandlesToConnections */],
  ],
  __WEBPACK_IMPORTED_MODULE_4__map_slots_js__["a" /* MapSlots */],
  __WEBPACK_IMPORTED_MODULE_8__create_description_handle_js__["a" /* CreateDescriptionHandle */],
  __WEBPACK_IMPORTED_MODULE_13__resolve_recipe_js__["a" /* ResolveRecipe */]
).build();
...
class SearchTokensToParticles extends __WEBPACK_IMPORTED_MODULE_1__strategizer_strategizer_js__["b" /* Strategy */] {
  constructor(arc) {
    ...
    this._walker = new SearchWalker(__WEBPACK_IMPORTED_MODULE_3__recipe_walker_js__["a" /* Walker */].Permuted, arc);
  }
...
class MockSlotDomConsumer extends __WEBPACK_IMPORTED_MODULE_1__slot_dom_consumer_js__["a" /* SlotDomConsumer */] {
  ...
  getInnerContainer(innerSlotName) {
    ...
    if (this.consumeConn.slotSpec.getProvidedSlotSpec(innerSlotName).isSet &&
      ...
      for (let itemModel of model.items.models) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(itemModel.id);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MockSlotDomConsumer;
...
class StorageProviderBase {
    ...
    _compareTo(other) {
        ...
        if ((cmp = __WEBPACK_IMPORTED_MODULE_2__recipe_util_js__["b" /* compareStrings */](this.source, other.source)) != 0)
            return cmp;
        if ((cmp = __WEBPACK_IMPORTED_MODULE_2__recipe_util_js__["b" /* compareStrings */](this.id, other.id)) != 0)
            return cmp;
        return 0;
    }
    toString(handleTags) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__in_memory_storage__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__firebase_storage__ = __webpack_require__(111);
// @
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
...
class TypeVariable {
  constructor(name, canWriteSuperset, canReadSubset) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(canWriteSuperset == null || canWriteSuperset instanceof __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */]);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(canReadSubset == null || canReadSubset instanceof __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */]);
    this.name = name;
  ...
  maybeMergeCanReadSubset(constraint) {
    ...
    this.canReadSubset = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].newEntity(mergedSchema);
    return true;
  }
  ...
  maybeMergeCanWriteSuperset(constraint) {
    ...
    this.canWriteSuperset = __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].newEntity(mergedSchema);
    return true;
  }
  ...
  set resolution(value) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(value instanceof __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */]);
  ...
  static fromLiteral(data) {
    return new TypeVariable(
        data.name,
        data.canWriteSuperset ? __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].fromLiteral(data.canWriteSuperset) : null,
        data.canReadSubset ? __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].fromLiteral(data.canReadSubset) : null);
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_date_web_js__ = __webpack_require__(34);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = atob;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__runtime_debug_abstract_devtools_channel_js__ = __webpack_require__(74);
/**
 * @license
 * Copyright (c) 2018 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__arc_stores_fetcher_js__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__devtools_connection_js__ = __webpack_require__(12);
/**
 * @license
 * Copyright (c) 2018 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__message_channel_js__ = __webpack_require__(90);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slot_consumer_js__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hosted_slot_context_js__ = __webpack_require__(87);
/**
 * @license
 * Copyright (c) 2018 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class HostedSlotConsumer extends __WEBPACK_IMPORTED_MODULE_1__slot_consumer_js__["a" /* SlotConsumer */] {
  ...
  set consumeConn(consumeConn) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this.hostedSlotId == consumeConn.targetSlot.id,
      `Expected target slot ${this.hostedSlotId}, but got ${consumeConn.targetSlot.id}`);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this.hostedParticleName == consumeConn.particle.name,
      `Expected particle ${this.hostedParticleName} for slot ${this.hostedSlotId}, but got ${consumeConn.particle.name}`);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this.hostedSlotName == consumeConn.name,
  ...
  createProvidedContexts() {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(this.consumeConn, `Cannot create provided context without consume connection for hosted slot ${this.hostedSlotId}`);
    return this.consumeConn.slotSpec.providedSlots.map(providedSpec => {
      return new __WEBPACK_IMPORTED_MODULE_2__hosted_slot_context_js__["a" /* HostedSlotContext */](this.arc.generateID(), providedSpec, this);
    });
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = HostedSlotConsumer;
...
class HostedSlotContext extends __WEBPACK_IMPORTED_MODULE_1__slot_context_js__["a" /* SlotContext */] {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = HostedSlotContext;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__random_js__ = __webpack_require__(93);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__handle_js__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_channel_js__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__storage_proxy_js__ = __webpack_require__(102);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_recipe_resolver_js__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__arc_exceptions_js__ = __webpack_require__(71);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__slot_composer_js__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__strategies_create_handle_group_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__strategies_add_missing_handles_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__strategies_rulesets_js__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__recipe_recipe_util_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__recipe_handle_js__ = __webpack_require__(7);
...
const IndexStrategies = [
  ...
  __WEBPACK_IMPORTED_MODULE_11__strategies_add_missing_handles_js__["a" /* AddMissingHandles */],
...
class RecipeIndex {
  ...
  findCoalescableHandles(recipe, otherRecipe, usedHandles) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_17__platform_assert_web_js__["a" /* assert */])(recipe != otherRecipe, 'Cannot coalesce handles in the same recipe');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slot_connection_js__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__handle_connection_js__ = __webpack_require__(95);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ts_build_storage_crdt_collection_model_js__ = __webpack_require__(30);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class CollectionProxy extends StorageProxyBase {
  constructor(...args) {
    super(...args);
    this._model = new __WEBPACK_IMPORTED_MODULE_1__ts_build_storage_crdt_collection_model_js__["a" /* CrdtCollectionModel */]();
  }
  _getModelForSync() {
  ...
  _synchronizeModel({version, model}) {
    ...
    this._model = new __WEBPACK_IMPORTED_MODULE_1__ts_build_storage_crdt_collection_model_js__["a" /* CrdtCollectionModel */](model);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__strategizer_strategizer_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recipe_recipe_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_recipe_util_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_walker_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_handle_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ts_build_type_js__ = __webpack_require__(4);
    ...
    return __WEBPACK_IMPORTED_MODULE_1__recipe_recipe_js__["a" /* Recipe */].over(this.getResults(inputParams), new class extends __WEBPACK_IMPORTED_MODULE_3__recipe_walker_js__["a" /* Walker */] {
      ...
      onSlotConnection(recipe, slotConnection) {
        ...
        for (let providedSlot of index.findProvidedSlot(slotConnection)) {
          ...
          if (__WEBPACK_IMPORTED_MODULE_2__recipe_recipe_util_js__["a" /* RecipeUtil */].matchesRecipe(arc.activeRecipe, providedSlot.recipe)) {
      ...
      onSlot(recipe, slot) {
        ...
        for (let {slotConn, matchingHandles} of index.findConsumeSlotConnectionMatch(slot)) {
          ...
          if (__WEBPACK_IMPORTED_MODULE_2__recipe_recipe_util_js__["a" /* RecipeUtil */].matchesRecipe(arc.activeRecipe, slotConn.recipe)) {
            // skip candidate recipe, if matches the shape of the arc's active recipe
            continue;
          }

          if (__WEBPACK_IMPORTED_MODULE_2__recipe_recipe_util_js__["a" /* RecipeUtil */].matchesRecipe(recipe, slotConn.recipe)) {
      ...
      onHandle(recipe, handle) {
        ...
        for (let otherHandle of index.findHandleMatch(handle, index.coalescableFates)) {
          ...
          if (__WEBPACK_IMPORTED_MODULE_2__recipe_recipe_util_js__["a" /* RecipeUtil */].matchesRecipe(arc.activeRecipe, otherHandle.recipe)) {
            // skip candidate recipe, if matches the shape of the arc's active recipe
            continue;
          }

          if (__WEBPACK_IMPORTED_MODULE_2__recipe_recipe_util_js__["a" /* RecipeUtil */].matchesRecipe(recipe, otherHandle.recipe)) {
            // skip candidate recipe, if matches the shape of the currently explored recipe
            continue;
          }
...
class SuggestDomConsumer extends __WEBPACK_IMPORTED_MODULE_1__slot_dom_consumer_js__["a" /* SlotDomConsumer */] {
  ...
  static render(container, plan, content) {
    let consumer = new __WEBPACK_IMPORTED_MODULE_1__slot_dom_consumer_js__["a" /* SlotDomConsumer */]();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SuggestDomConsumer;
  ...
  _addInlineSuggestion(suggestion, suggestionContent) {
    ...
    let suggestConsumer = new this._affordance.suggestionConsumerClass(this._slotComposer._containerKind, suggestion, suggestionContent, (eventlet) => {
      ...
      if (suggestion) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__["a" /* assert */])(index >= 0, 'cannot find suggest slot context');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_slot_dom_consumer_js__ = __webpack_require__(54);
/**
 * @license
 * Copyright (c) 2018 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class MockSuggestDomConsumer extends __WEBPACK_IMPORTED_MODULE_1__mock_slot_dom_consumer_js__["a" /* MockSlotDomConsumer */] {
  constructor(containerKind, suggestion, suggestionContent, eventHandler) {
    super(/* consumeConn= */null, containerKind);
    this._suggestion = suggestion;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MockSuggestDomConsumer;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__storage_provider_base__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_firebase_web_js__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__key_base__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__crdt_collection_model__ = __webpack_require__(30);
// @
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
...
function resetStorageForTesting(key) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        reference = __WEBPACK_IMPORTED_MODULE_1__platform_firebase_web_js__["a" /* firebase */].database(app).ref('backingStores');
        yield new Promise(resolve => {
            reference.remove(resolve);
        });
        app.delete();
...
class FirebaseStorage {
    ...
    static encodeKey(key) {
        key = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__platform_btoa_web_js__["a" /* btoa */])(key);
        return key.replace(/\//g, '*');
    }
    static decodeKey(key) {
        key = key.replace(/\*/g, '/');
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__platform_atob_web_js__["a" /* atob */])(key);
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tracelib_trace_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__storage_provider_base__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__key_base__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__crdt_collection_model__ = __webpack_require__(30);
// @
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
// http://polymer.github.io/LICENSE.txt
...
class TupleFields {
  ...
  static fromLiteral(literal) {
    return new TupleFields(literal.map(a => __WEBPACK_IMPORTED_MODULE_0__ts_build_type_js__["a" /* Type */].fromLiteral(a)));
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__runtime_slot_composer_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__runtime_ts_build_type_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__browser_loader_js__ = __webpack_require__(60);
...
const Arcs = {
  ...
  Type: __WEBPACK_IMPORTED_MODULE_6__runtime_ts_build_type_js__["a" /* Type */],
  BrowserLoader: __WEBPACK_IMPORTED_MODULE_7__browser_loader_js__["a" /* BrowserLoader */],
  Tracing: __WEBPACK_IMPORTED_MODULE_8__tracelib_trace_js__["a" /* Tracing */],
};
