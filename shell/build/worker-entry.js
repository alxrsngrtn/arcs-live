...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shape_js__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dom_particle_base_js__ = __webpack_require__(25);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recipe_type_checker_js__ = __webpack_require__(5);
...
class ParticleSpec {
    ...
    static fromLiteral(literal) {
        ...
        let connectionFromLiteral = ({ type, direction, name, isOptional, dependentConnections }) => ({ type: __WEBPACK_IMPORTED_MODULE_0__type_js__["a" /* Type */].fromLiteral(type), direction, name, isOptional, dependentConnections: dependentConnections ? dependentConnections.map(connectionFromLiteral) : [] });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__transformation_dom_particle_js__ = __webpack_require__(6);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__entity_js__ = __webpack_require__(26);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__type_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_type_checker_js__ = __webpack_require__(5);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class TypeVariable {
    ...
    set resolution(value) {
        ...
        if (resolvedValue.isCollection && resolvedValue.collectionType.isVariable) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(resolvedValue.collectionType.variable != this, 'variable cannot resolve to collection of itself');
        }
        let probe = value;
        while (probe) {
            if (!probe.isVariable) {
    ...
    static fromLiteral(data) {
        return new TypeVariable(data.name, data.canWriteSuperset ? __WEBPACK_IMPORTED_MODULE_0__type_js__["a" /* Type */].fromLiteral(data.canWriteSuperset) : null, data.canReadSubset ? __WEBPACK_IMPORTED_MODULE_0__type_js__["a" /* Type */].fromLiteral(data.canReadSubset) : null);
    }
    isResolved() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_channel_js__ = __webpack_require__(19);
...
class ParticleExecutionContext {
    constructor(port, idBase, loader) {
        ...
        this._apiPort.onStopRender = ({ particle, slotName }) => {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(particle._slotByName.has(slotName), `Stop render called for particle ${particle.name} slot ${slotName} without start render being called.`);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__intermediate_runtime_loader_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__intermediate_runtime_particle_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__intermediate_runtime_dom_particle_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__intermediate_runtime_multiplexer_dom_particle_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__intermediate_runtime_transformation_dom_particle_js__ = __webpack_require__(6);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class BrowserLoader extends __WEBPACK_IMPORTED_MODULE_0__intermediate_runtime_loader_js__["a" /* Loader */] {
  constructor(urlMap) {
    super();
    this._urlMap = urlMap;
  }
  ...
  unwrapParticle(particleWrapper, log) {
    ...
    return particleWrapper({
      Particle: __WEBPACK_IMPORTED_MODULE_1__intermediate_runtime_particle_js__["a" /* Particle */],
      DomParticle: __WEBPACK_IMPORTED_MODULE_2__intermediate_runtime_dom_particle_js__["a" /* DomParticle */],
      MultiplexerDomParticle: __WEBPACK_IMPORTED_MODULE_3__intermediate_runtime_multiplexer_dom_particle_js__["a" /* MultiplexerDomParticle */],
      SimpleParticle: __WEBPACK_IMPORTED_MODULE_2__intermediate_runtime_dom_particle_js__["a" /* DomParticle */],
      TransformationDomParticle: __WEBPACK_IMPORTED_MODULE_4__intermediate_runtime_transformation_dom_particle_js__["a" /* TransformationDomParticle */],
      resolver,
      log,
      html
    });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__debug_devtools_connection_js__ = __webpack_require__(22);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class PECOuterPort extends APIPort {
    constructor(messagePort, arc) {
        ...
        this.registerInitializer('InstantiateParticle', { id: this.Direct, spec: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_1__particle_spec_js__["a" /* ParticleSpec */]), handles: this.Map(this.Direct, this.Mapped) }, 'id');
        ...
        __WEBPACK_IMPORTED_MODULE_4__debug_devtools_connection_js__["a" /* DevtoolsConnection */].onceConnected.then(devtoolsChannel => this._debugAttachment = new __WEBPACK_IMPORTED_MODULE_3__debug_outer_port_attachment_js__["a" /* OuterPortAttachment */](arc, devtoolsChannel));
    }
}
...
class PECInnerPort extends APIPort {
    constructor(messagePort) {
        ...
        this.registerInitializerHandler('InstantiateParticle', { id: this.Direct, spec: this.ByLiteral(__WEBPACK_IMPORTED_MODULE_1__particle_spec_js__["a" /* ParticleSpec */]), handles: this.Map(this.Direct, this.Mapped) });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_devtools_channel_web_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__testing_devtools_channel_stub_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__devtools_shared_devtools_broker_js__ = __webpack_require__(15);
/**
 * @license
 * Copyright (c) 2018 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
class DevtoolsConnection {
    ...
    static ensure() {
        if (!channel)
            channel = new __WEBPACK_IMPORTED_MODULE_1__platform_devtools_channel_web_js__["a" /* DevtoolsChannel */]();
    }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__symbols_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__type_js__ = __webpack_require__(1);
// @license
// Copyright (c) 2017 Google Inc. All rights reserved.
// This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__symbols_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__particle_spec_js__ = __webpack_require__(3);
/** @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
function restore(entry, entityClass) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(entityClass, 'Handles need entity classes for deserialization');
...
class Handle {
    constructor(proxy, name, particleId, canRead, canWrite) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(!(proxy instanceof Handle));
        this._proxy = proxy;
    ...
    configure(options) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(this.canRead, 'configure can only be called on readable Handles');
        try {
...
class Collection extends Handle {
    ...
    _notify(kind, particle, details) {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__platform_assert_web_js__["a" /* assert */])(this.canRead, '_notify should not be called for non-readable handles');
        switch (kind) {
            case 'sync':
...
class Variable extends Handle {
    ...
    * throws: Error if this variable is not configured as a readable handle (i.e. 'in' or 'inout')
    ...
    _restore(model) {
        ...
        return this.type.isInterface ? __WEBPACK_IMPORTED_MODULE_2__particle_spec_js__["a" /* ParticleSpec */].fromLiteral(model) : model;
    }
    /** @method set(entity)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_fs_web_js__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__transformation_dom_particle_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__converters_jsonldToManifest_js__ = __webpack_require__(20);
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_assert_web_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__storage_crdt_collection_model_js__ = __webpack_require__(31);
/**
 * @license
 * Copyright (c) 2017 Google Inc. All rights reserved.
 * This code may only be used under the BSD style license found at
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__intermediate_runtime_particle_execution_context_js__ = __webpack_require__(13);
...
self.onmessage = function(e) {
  ...
  new __WEBPACK_IMPORTED_MODULE_0__intermediate_runtime_particle_execution_context_js__["a" /* ParticleExecutionContext */](e.ports[0], id, new __WEBPACK_IMPORTED_MODULE_1__browser_loader_js__["a" /* BrowserLoader */](base));
};
